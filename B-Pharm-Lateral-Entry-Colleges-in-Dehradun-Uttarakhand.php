...
<head>
    ...
    <title>Guru Nanak College | Best B.Pharma (Lateral Entry) College in Dehradun, Uttarakhand</title>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>Lateral Entry into the Bachelor of Pharmacy (B.Pharm) program at Guru Nanak College - Best
                            ...
                            these students to directly join the B.Pharm program in the second year, effectively bypassing the first
                            year of the standard curriculum.</p>
                        <p>The program at Guru Nanak College focuses on advanced pharmaceutical sciences, covering critical
                            ...
                            drug action, and regulatory aspects. This blend of theoretical and practical learning equips students for
                            diverse roles in the pharmaceutical industry, effectively bridging the gap between academic training and
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/Hf9j2CCXBto?autoplay=1&mute=1&playlist=Hf9j2CCXBto&loop=1"
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/pharmacy-image.webp" alt="pharmacy showcase" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Lateral Entry Bachelor of Pharmacy (B.Pharm)</h2>
                            </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>85,000 /- (Included Power Degree Fee)</b></td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
