...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://www.gnc.edu.in/paramedical-college">
</head>
<body>
    ...
    <div class="swiper banner-slider">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="assets/image/banner-1.webp" alt="DIS Mobile Banner" class="banner-image w-100" width="auto" height="auto">
...
<div class="floating-social">
  <a href="https://wa.me/917300900929" target="_blank" class="social-icon whatsapp" title="Chat on WhatsApp">
    <i class="fab fa-whatsapp"></i>
  </a>
  <a href="tel:+917300900929" class="social-icon call" title="Call Now">
...
<section class="kc-scholarship-benefits" aria-labelledby="kc-scholarship-title">
 ...
 <section id="programs" class="py-5 ">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold text-white" data-aos="fade-up">Our Paramedical Science Courses</h2>
      ...
      <div class="col-md-4 filter-item paramedical" data-aos="zoom-in">
        <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">3+1 Years | Fee: ₹65,000 /- (Included Power Degree Fee)</p>
      ...
      <div class="col-md-4 filter-item paramedical" data-aos="zoom-in" data-aos-delay="100">
        <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">3+0.5 Years | Fee: ₹65,000 /- (Included Power Degree Fee)</p>
            <div class="text-center mt-auto">
              <a href="#" class="btn btn-primary apply-now-btn mt-2 w-50">Apply Now</a>
            </div>
          </div>
      ...
      <div class="col-md-4 filter-item paramedical" data-aos="zoom-in" data-aos-delay="200">
        <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">4+0.5 Years | Fee: ₹65,000 /- (Included Power Degree Fee)</p>
            <div class="text-center mt-auto">
              <a href="#" class="btn btn-primary apply-now-btn mt-2 w-50">Apply Now</a>
            </div>
          </div>
      ...
      <div class="col-md-4 filter-item paramedical hidden-course" style="display: none;">
        <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">4 Years | Fee: ₹65,000 / year (Included Power Degree Fee)</p>
            <div class="text-center mt-auto">
              <a href="#" class="btn btn-primary apply-now-btn mt-2 w-50">Apply Now</a>
            </div>
          </div>
       ...
       <div class="col-md-4 filter-item paramedical hidden-course" style="display: none;">
        <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">2 Years | Fee: ₹55,000/ (+₹20,000 optional for power degree)year</p>
            <div class="text-center mt-auto">
              <a href="#" class="btn btn-primary apply-now-btn mt-2 w-50">Apply Now</a>
            </div>
          </div>
      ...
      <div class="col-md-4 filter-item paramedical hidden-course" data-aos="zoom-in" data-aos-delay="200">
        <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">2 Years | Fee: ₹65,000/ (+₹20,000 optional for power degree)year</p>
            <div class="text-center mt-auto">
              <a href="#" class="btn btn-primary apply-now-btn mt-2 w-50">Apply Now</a>
            </div>
          </div>
...
<script>
  ...
  const showMoreSchools = ["paramedical"];
  ...
  btn.addEventListener('click', (e) => {
    ...
    if (formContainer) {
      ...
      console.error("Target form container not found. Cannot scroll.");
        }
     });
  });
...
<style>
  ...
  <footer>
    ...
    <p>Jhajhra, Chakrata Rd, Dehradun, Uttarakhand 248007 | Call: +91-7300900929</p>
      <p>© 2026 Guru Nanak College. All Rights Reserved.</p>
    </div>
  </footer>
