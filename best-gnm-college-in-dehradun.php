...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/gnm-head.webp'); background-repeat: no-repeat; background-size: cover;">
                            ...
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    <div class="pb-flex d-flex align-items-center justify-content-center justify-content-lg-start mt-3">
                                        <h5 class=" text-white border-right me-3 pe-3 mb-0">General</h5>
                                    </div>
                                ...
                                <a href="upload/pdf/GNM.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
        ...
        <div class="main-container">
            <div class="hero-layout">
                ...
                <div class="hero-content-left">
                    <h2>Guru Nanak College - Best GNM College in Dehradun, Uttarakhand</h2>
                ...
                <div class="hero-image-right">
                    <img src="upload/infra/gnm.webp" alt="Bsc Nursing Showcase">
                </div>
            ...
            <div class="flex-container">
                ...
                <div class="col-data">
                    ...
                    <ul class="nav nav-tabs" id="gncTabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <button class="nav-link" id="other-tab" data-bs-toggle="tab" data-bs-target="#other-content" type="button" role="tab">Hostel Fees</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">10+2 with English and must have obtained a minimum of 40% at the qualifying examination and
                                English individually for any recognized board. Candidates are also eligible from State Open School
                                recognized by State Government and National Institute of Open School (NIOS) recognized by Central
                                Government. However, Science is preferable.</p>
                            <p>10+2 with English having 40% of marks in vocational ANM course from the school recognized by Indian
                                Nursing council.</p>
                            <p>10+2 with English having 40% of marks in Vocational Stream-Health care Science from a recognized
                                CBSE board/Centre.</p>
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th valign="top">Course Fee<br>(Per Year)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="6">Registration Charges, Admission Charges, Lab, Library, Medical Consultation &amp; Ambulance Service, ERP Membership Charges, Hospital training, Uniform Charges (Winter/Summer/Sports/Lab Practical).</td>
                                        </tr>
                            ...
                            <h5>Merit Based Scholarships (12th %)</h5>
                            <div class="table-responsive">
                                <table>
                                    <thead>
                                        <tr>
                            ...
                            <div class="table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="3"><strong>Note:</strong> Package seats are offered for the complete duration of course only.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/VVkrWNioLT4?autoplay=1&mute=1&playlist=VVkrWNioLT4&loop=1" title="D.Pharm Program Video" allowfullscreen></iframe>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 student-image-col">
                    ...
                    <img src="upload/infra/student-1.webp" alt="GNC GNM Students" class="student-img-cutout">
                </div>
                ...
                <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                    <h3>Career Opportunities in <br>Nursing (GNM)</h3>
                    <p>Graduates of General Nursing and Midwifery (GNM) have diverse career opportunities in the healthcare sector. They can work as Registered Nurses in hospitals, clinics, and community health centers, providing patient care and support. Specializations in fields like pediatrics or critical care are possible with additional training. Public health nursing offers roles in community health education and wellness campaigns.</p>

                    <p>GNM graduates can also enter nursing education, teaching future nurses, or take up administrative roles like nursing supervisors. Opportunities extend to industrial and home care nursing, and for those looking internationally, there's a high demand for skilled nurses abroad. Further studies, like a BSc in Nursing, can lead to advanced nursing roles and higher positions in healthcare.</p>
                </div>

                <!-- 3. Key Career Fields (Right) -->
                <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                    <h6 class="fw-bold mb-4" style="font-size: 1rem;">GNM Career Scope</h6>
                    <ul class="feature-list">
                        <li><i class="fas fa-check"></i>
                            <div><b>Registered Nurses:</b> Working in hospitals, clinics, and community health centers to provide patient care.</div>
                        </li>
                        <li><i class="fas fa-check"></i>
                            <div><b>Clinical Specializations:</b> Pursuing roles in pediatrics or critical care with additional specialized training.</div>
                        </li>
                        <li><i class="fas fa-check"></i>
                            <div><b>Public Health:</b> Engaging in community health education and wellness campaigns.</div>
                        </li>
                        <li><i class="fas fa-check"></i>
                            <div><b>Education & Admin:</b> Teaching future nurses or taking up roles as nursing supervisors.</div>
                        </li>
                        <li><i class="fas fa-check"></i>
                            <div><b>Industrial & Home Care:</b> Providing nursing services in corporate settings or private home care.</div>
                        </li>
                        <li><i class="fas fa-check"></i>
                            <div><b>International Demand:</b> Exploring high-demand nursing opportunities in the global healthcare market.</div>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="why-join-content">
                        <h3>Why Join Guru Nank College For General Nursing and Midwifery (GNM) in Dehradun?</h3>
                        <p>At the School of Nursing, a part of the renowned Guru Nanak College in Dehradun, we commit ourselves to delivering exceptional education in nursing sciences.</p>

                        <p>Our aim is to cultivate proficient professionals who are well-prepared to meet global healthcare challenges.
                            The campus boasts state-of-the-art educational facilities, fostering a well-rounded learning environment.</p>
                        ...
                        <ul class="check-list-white">
                            ...
                            <li class="d-flex align-items-start mb-3">
                                ...
                                <div class="ms-3">
                                    <p class="mb-0">A rich, centrally managed library with extensive resources.</p>
                                </div>
                            </li>
                            ...
                            <li class="d-flex align-items-start mb-3">
                                <i class="fas fa-check mt-1"></i>
                                <div class="ms-3">
                                    <p class="mb-0">Modern laboratories, outfitted with cutting-edge technology.</p>
                                </div>
                            </li>
                            ...
                            <li class="d-flex align-items-start mb-3">
                                <i class="fas fa-check mt-1"></i>
                                <div class="ms-3">
                                    <p class="mb-0">A faculty comprising highly qualified and seasoned professionals.</p>
                                </div>
                            </li>
                            ...
                            <li class="d-flex align-items-start mb-3">
                                <i class="fas fa-check mt-1"></i>
                                <div class="ms-3">
                                    <p class="mb-0">An innovative teaching approach that blends traditional methods with modern techniques.</p>
                                </div>
                            </li>
                            ...
                            <li class="d-flex align-items-start mb-3">
                                <i class="fas fa-check mt-1"></i>
                                <div class="ms-3">
                                    <p class="mb-0">We prioritize value-based education, emphasizing the development of critical thinking, problem-solving skills, and a flair for innovation and research.</p>
                                </div>
                            </li>
                            ...
                            <li class="d-flex align-items-start mb-3">
                                <i class="fas fa-check mt-1"></i>
                                <div class="ms-3">
                                    <p class="mb-0">Understanding the significance of career preparedness, we provide comprehensive placement training, equipping our students for thriving careers in the nursing and healthcare sectors.</p>
                                </div>
                            </li>
                        </ul>
