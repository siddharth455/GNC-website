...
<head>
    ...
    <title>Guru Nanak College | Best Nursing & Midway (GNM) College in Dehradun Uttarakhand</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/VVkrWNioLT4?autoplay=1&mute=1&playlist=VVkrWNioLT4&loop=1"
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/gnm.webp" alt="gnm showcase" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">General Nursing and Midwifery(GNM)</h2>
                            </div>
