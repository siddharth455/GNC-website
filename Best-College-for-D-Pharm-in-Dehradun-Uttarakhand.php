...
<body>
  ...
  <section class="pageBanner-inner">
        <div style="background-image: url('upload/d-pharma.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Pharmacy (D.Pharm)</small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                                <a href="upload/pdf/d-pharma.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best Diploma in Pharmacy (D.Pharma) College in Dehradun, Uttarakhand</h2>
                
                          <p>The Diploma in Pharmacy (D.Pharma) at Guru Nanak College - Best D.Pharma College in
Dehradun, Uttarakhand is a comprehensive two-year course designed for students interested in
entering the pharmaceutical sector. This program provides a foundational understanding of
pharmaceutical sciences, covering key areas such as pharmacology, pharmaceutical chemistry,
pharmacognosy, and pharmaceutics.</p>
                        <p>In the first year at Guru Nanak College - Best D.Pharma College in Dehradun, Uttarakhand, students are
introduced to the basics of medicinal chemistry, human anatomy and physiology, and the principles of
biochemistry. This foundation is crucial for understanding the complexities of drug formulation and
action. The second year delves deeper into pharmaceutical laws and ethics, drug interactions, and the
preparation and dispensing of medications.</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For D.Pharma in Dehradun?</h3>
