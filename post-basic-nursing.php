...
<head>
 <link rel="icon" type="image/webp" href="images/logog.webp">
    ...
    <meta name="description" content="Guru Nanak College, the top Post Basic Nursing college in Dehradun, Uttarakhand. Known for its comprehensive curriculum, expert faculty, and...">
    <link rel="canonical" href="https://www.gnc.edu.in/post-basic-nursing">
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Best Post Basic Nursing College in Dehradun, Uttarakhand, India - GNC Dehradun" />
    <meta property="og:description" content="Guru Nanak College, the top Post Basic Nursing college in Dehradun, Uttarakhand. Known for its comprehensive curriculum, expert faculty, and state-of-the-art clinical training, Guru Nanak College prepares future nursing professionals to excel in the healthcare industry with compassion and excellence." />
  ...
  <script type="application/ld+json">
    {
      ...
      "description": "2-year undergraduate nursing degree approved by Indian Nursing Council (INC), affiliated with HNBGU. Designed for registered GNM nurses to advance their knowledge and skills.",
      "provider": {
      ...
      "coursePrerequisites": "GNM diploma or equivalent from a recognized nursing institution with minimum 50% marks"
    }
    </script>
...
.stat-label{font-size:13px;font-weight:700;color:#000 !important;margin-bottom:3px}
...
<section class="hero">
  ...
  <div class="hero-inner">
    <div>
      ...
      <h1>Post Basic <span>Bachelor of</span><br><span class="acc">Science in Nursing</span></h1>
      <p class="hero-desc">Join Guru Nanak College — Dehradun's most trusted name in healthcare education. A 2-year advanced program designed for registered GNM nurses to elevate their clinical knowledge, leadership skills, and career prospects.</p>
      <div class="hero-btns">
        <a href="https://application.gnc.edu.in/" target="_blank" class="g-btn g-btn-blue">Apply Now 2026 <i class="fas fa-arrow-right"></i></a>
        <a href="upload/pdf/Post-Basic-Nursing.pdf" target="_blank" class="g-btn g-btn-white"><i class="fas fa-download"></i> Download Brochure</a>
      </div>
      <div class="hero-pills">
        <div class="hero-pill"><i class="fas fa-clock"></i> 2-Year Program</div>
        <div class="hero-pill"><i class="fas fa-indian-rupee-sign"></i> ₹1L/Year</div>
...
<div class="g-ticker">
  <div class="g-ticker-track">
    <div class="g-ticker-item"><span>2 Yrs</span> Undergraduate Program</div>
    ...
    <div class="g-ticker-item"><span>₹1L</span> Annual Fee</div>
  ...
  <div class="g-wrap">
    <div class="about-grid">
      <div class="about-imgs" data-ani="left">
        <div class="about-img-main"><img src="upload/infra/nursing-3.jpg" alt="Post Basic Nursing at GNC Dehradun" width="auto" height="auto"></div>
        <div class="about-img-sub"><img src="upload/infra/gnm.webp" alt="GNC Post Basic Nursing Students" width="auto" height="auto"></div>
        <div class="about-badge"><strong>2+</strong><span>Years of Excellence</span></div>
      </div>
      <div data-ani="right">
        <p class="g-tag">About the Program</p>
        <h2 class="g-heading">Guru Nanak College — Best <em>Post Basic Nursing</em> College in <span class="acc">Dehradun</span></h2>
        ...
        <div style="margin-top:28px;display:flex;gap:12px;flex-wrap:wrap">
          ...
          <a href="upload/pdf/Post-Basic-Nursing.pdf" target="_blank" class="g-btn g-btn-outline"><i class="fas fa-download"></i> Brochure</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="g-sec hl-sec">
  <div class="g-wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:end;margin-bottom:10px">
      ...
      <p class="g-sub" style="color:rgba(255,255,255,.6)" data-ani="right">A structured, advanced program designed to elevate registered GNM nurses into competent, confident, and globally-ready healthcare professionals.</p>
    </div>
    <div class="hl-grid">
      ...
      <div class="hl-card" data-ani="up" data-delay="2"><div class="hl-ico">🔬</div><div class="hl-title">Advanced Simulation Labs</div><div class="hl-desc">State-of-the-art simulation labs mimicking real ICU, OT, and ward environments for advanced skill building.</div></div>
      <div class="hl-card" data-ani="up" data-delay="3"><div class="hl-ico">🏥</div><div class="hl-title">Clinical Rotations</div><div class="hl-desc">Supervised clinical postings across Medicine, Surgery, OBG, Pediatrics, and Community Health settings.</div></div>
      <div class="hl-card" data-ani="up" data-delay="4"><div class="hl-ico">🌍</div><div class="hl-title">Global Career Scope</div><div class="hl-desc">P.B.B.Sc. Nursing graduates are in high demand in GCC, UK, USA, Canada, and Australia.</div></div>
    </div>
  </div>
</section>
...
<section class="g-sec curr-sec">
  <div class="g-wrap">
    <div style="text-align:center;max-width:600px;margin:0 auto" data-ani="up">
      ...
      <h2 class="g-heading" style="color:#fff">2-Year <em style="color:var(--blue)">Curriculum</em> Breakdown</h2>
    ...
    <div class="curr-tabs">
      <button class="curr-tab-btn active" onclick="switchCurr(this,'cy1')">Year 1 — Advanced Foundations</button>
      <button class="curr-tab-btn" onclick="switchCurr(this,'cy2')">Year 2 — Speciality &amp; Leadership</button>
    ...
    <div id="cy1" class="curr-pane active">
      <div class="curr-content">
        ...
        <div class="curr-year-title">Advanced Foundations of Nursing</div>
        <ul class="curr-topics">
          ...
          <li><i class="fas fa-circle"></i> Psychology &amp; Sociology</li>
          <li><i class="fas fa-circle"></i> Fundamentals of Advanced Nursing</li>
      ...
      <div class="curr-sidebar">
        <div>
          ...
          <div class="curr-feature"><div class="curr-feature-ico"><i class="fas fa-brain"></i></div><div class="curr-feature-text">Strengthen advanced nursing science knowledge for complex clinical scenarios</div></div>
          <div class="curr-feature"><div class="curr-feature-ico"><i class="fas fa-hands-helping"></i></div><div class="curr-feature-text">Develop refined patient care and assessment competencies</div></div>
          <div class="curr-feature"><div class="curr-feature-ico"><i class="fas fa-hospital"></i></div><div class="curr-feature-text">Begin supervised advanced clinical postings in hospital settings</div></div>
        </div>
        <div class="curr-cta">
          <p>Interested in our curriculum details?</p>
          <a href="upload/pdf/Post-Basic-Nursing.pdf" target="_blank"><i class="fas fa-download"></i> Download Brochure</a>
        </div>
      </div>
    </div>
    ...
    <div id="cy2" class="curr-pane">
      <div class="curr-content">
        ...
        <div class="curr-year-title">Speciality Nursing &amp; Leadership</div>
        <ul class="curr-topics">
          <li><i class="fas fa-circle"></i> Medical-Surgical Nursing</li>
          ...
          <li><i class="fas fa-circle"></i> Nursing Management &amp; Administration</li>
          <li><i class="fas fa-circle"></i> Research Methodology &amp; Dissertation</li>
        </ul>
      </div>
      <div class="curr-sidebar">
        <div>
          <h4>Year 2 Outcomes</h4>
          <div class="curr-feature"><div class="curr-feature-ico"><i class="fas fa-baby"></i></div><div class="curr-feature-text">Specialize in pediatrics, OBG, mental health, and critical care nursing</div></div>
          <div class="curr-feature"><div class="curr-feature-ico"><i class="fas fa-tasks"></i></div><div class="curr-feature-text">Develop nursing leadership, management, and administrative capabilities</div></div>
          <div class="curr-feature"><div class="curr-feature-ico"><i class="fas fa-microscope"></i></div><div class="curr-feature-text">Complete research dissertation and placement-ready preparation</div></div>
        </div>
        <div class="curr-cta">
          <p>Interested in our curriculum details?</p>
          <a href="upload/pdf/Post-Basic-Nursing.pdf" target="_blank"><i class="fas fa-download"></i> Download Brochure</a>
    ...
    <div class="fee-grid">
      <div class="fee-box" data-ani="left">
        ...
        <div id="ftab-fee" class="fee-pane active">
          <div class="elig-note"><strong>Eligibility:</strong> Must have completed GNM diploma or equivalent from a recognized nursing institution.<br>Min. <strong>50%</strong> marks in the GNM program.</div>
          ...
          <table class="g-table">
            ...
            <tbody>
              <tr><td>Fee (All Inclusive)</td><td><strong>₹1,00,000</strong></td></tr>
      ...
      <div data-ani="right">
        <div class="vid-wrap">
          <iframe src="https://www.youtube.com/embed/PpkHaa1lPjI?si=4OwoU7hdHJDseIZ0" title="Post Basic Nursing Program Video" allowfullscreen></iframe>
        </div>
        <div class="note-card">
...
<section class="g-sec scholar-sec">
  <div class="g-wrap">
    <div style="text-align:center;max-width:560px;margin:0 auto" data-ani="up">
      ...
      <p class="g-sub" style="margin:0 auto">Merit-based scholarships for first-year Uttarakhand domicile students based on GNM marks.</p>
    </div>
    <div class="sc-cards">
  ...
  <div class="g-wrap">
    <div class="career-grid">
      ...
      <div data-ani="right">
        ...
        <p class="g-sub" style="margin-bottom:22px">P.B.B.Sc. Nursing graduates step into advanced, rewarding career paths across India and globally.</p>
        <div class="career-list">
          <div class="career-item" data-ani="up" data-delay="1"><div class="career-ico"><i class="fas fa-hospital-user"></i></div><div><div class="career-title">Advanced Registered Nurse (RN)</div><div class="career-desc">Professional patient care in hospitals, clinics, or community healthcare centers.</div></div></div>
          <div class="career-item" data-ani="up" data-delay="2"><div class="career-ico"><i class="fas fa-baby"></i></div><div><div class="career-title">Specialized Nursing</div><div class="career-desc">High-impact areas like Pediatrics, Oncology, Critical Care, and Emergency Nursing.</div></div></div>
          <div class="career-item" data-ani="up" data-delay="3"><div class="career-ico"><i class="fas fa-tasks"></i></div><div><div class="career-title">Nursing Leadership</div><div class="career-desc">Manage clinical departments and shape healthcare policies and hospital operations.</div></div></div>
          <div class="career-item" data-ani="up" data-delay="4"><div class="career-ico"><i class="fas fa-globe-asia"></i></div><div><div class="career-title">International Nursing</div><div class="career-desc">GCC, UK, Canada, and Australia actively recruit qualified Indian nurses.</div></div></div>
          <div class="career-item" data-ani="up" data-delay="5"><div class="career-ico"><i class="fas fa-microscope"></i></div><div><div class="career-title">Public Health &amp; Research</div><div class="career-desc">Contribute to national health initiatives and engage in health studies and research.</div></div></div>
          <div class="career-item" data-ani="up" data-delay="6"><div class="career-ico"><i class="fas fa-chalkboard-teacher"></i></div><div><div class="career-title">Nurse Educator</div><div class="career-desc">Teach and train the next generation of future nursing professionals.</div></div></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div style="display:flex;flex-direction:column;gap:20px">
        ...
        <div class="admission-card" data-ani="right" data-delay="2">
          <div>
            ...
            <p>Merit-based selection using GNM qualifying examination marks, followed by university counselling to assess eligibility and confirm your seat.</p>
          </div>
  ...
  <div class="g-wrap">
    <div class="why-inner">
      <div class="why-text" data-ani="left">
        ...
        <h2 class="g-heading" style="color:#fff">Why Join Guru Nanak College for <em style="color:var(--blue)">Post Basic Nursing</em>?</h2>
        <p>At the Post Basic Nursing program, part of the esteemed Guru Nanak College in Dehradun, we are dedicated to providing exceptional education in advanced nursing sciences, cultivating professionals well-prepared to meet global healthcare challenges.</p>
        <ul class="why-list">
          ...
          <li><div class="why-chk"><i class="fas fa-check"></i></div>Innovative teaching blending traditional methods with modern techniques.</li>
          <li><div class="why-chk"><i class="fas fa-check"></i></div>Value-based education: critical thinking, ethics, innovation, and compassionate care.</li>
...
<section class="g-sec process-sec">
  <div class="g-wrap">
    ...
    <div class="steps">
      <div class="step" data-ani="up" data-delay="1"><div class="step-num">1</div><div class="step-title">Apply Online</div><div class="step-desc">Visit application.gnc.edu.in and fill out the application form with your GNM qualification details.</div></div>
      <div class="step" data-ani="up" data-delay="2"><div class="step-num">2</div><div class="step-title">Document Verification</div><div class="step-desc">Submit GNM marksheets, registration certificate, ID proof, photos and other required documents.</div></div>
...
<section class="g-sec faq-sec">
  <div class="g-wrap">
    ...
    <div class="faq-grid" data-ani="up">
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)"><span>What is the eligibility for Post Basic Nursing at GNC?</span><div class="faq-q-ico"><i class="fas fa-plus"></i></div></div>
        <div class="faq-a">Candidates must have completed a General Nursing and Midwifery (GNM) diploma or equivalent from a recognized nursing institution with a minimum of 50% marks in the GNM program.</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)"><span>Is Post Basic Nursing at GNC approved by INC?</span><div class="faq-q-ico"><i class="fas fa-plus"></i></div></div>
        <div class="faq-a">Yes, the P.B.B.Sc. Nursing program at Guru Nanak College is fully approved by the Indian Nursing Council (INC) and is affiliated with Hemvati Nandan Bahuguna Garhwal University (HNBGU).</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)"><span>What is the total fee for the 2-year program?</span><div class="faq-q-ico"><i class="fas fa-plus"></i></div></div>
        <div class="faq-a">The all-inclusive course fee is ₹1,00,000 per year. Over 2 years, the total course fee is ₹2,00,000. This includes registration, lab, library, transport, uniforms, events, and more. Hostel fees are additional.</div>
      </div>
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)"><span>Are scholarships available for Post Basic Nursing?</span><div class="faq-q-ico"><i class="fas fa-plus"></i></div></div>
      ...
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)"><span>What are the career options after P.B.B.Sc. Nursing?</span><div class="faq-q-ico"><i class="fas fa-plus"></i></div></div>
        <div class="faq-a">Graduates can pursue careers as advanced Registered Nurses, ICU/ER specialists, nursing managers, nurse educators, public health workers, and international nursing roles in GCC, UK, USA, Canada, and Australia.</div>
      </div>
      <div class="faq-item">
...
<section class="cta-sec" data-ani="scale">
  <div class="g-wrap">
    <h2>Advance Your Nursing Career Today 🩺</h2>
