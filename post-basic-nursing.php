                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/gnm.webp" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Post Basic Nursing</h2>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-2">
                            <li>Must have completed a General Nursing and Midwifery (GNM) diploma or equivalent from a recognized nursing institution.</li>
                            <li>Candidates should have secured a minimum of 50% marks in the GNM program</li>
                        </ul>
