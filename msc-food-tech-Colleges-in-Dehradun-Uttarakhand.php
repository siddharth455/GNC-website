                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                               ...
                               <a href="upload/pdf/MSc-Foodtech.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
        ...
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best M.Sc in Food Technology College in Dehradun, Uttarakhand</h2>
                  <p>The Master of Science in Food Technology program at Guru Nanak College, Dehradun is a
postgraduate course designed for students aiming to specialize in the science of food processing and
technology. This two-year program offers advanced knowledge and skills related to the processing,
preservation, quality control, and safety of food products. The curriculum includes a comprehensive
study of food chemistry, food microbiology, food engineering, food packaging, and nutrition.
</p>
                        <p>The M.Sc. Food Technology course is structured to blend theoretical principles with practical applications in the field of food science. Students will learn about the latest technologies and methods
used in food processing, techniques for ensuring food safety and quality, and the development of new
food products. The program also covers important aspects such as sensory evaluation of food, food laws
and regulations, and the impact of food technology on public health and nutrition.
</p>
<p>Guru Nanak College - Best M.Sc in Food Technology College in Dehradun, Uttarakhand provides an
excellent platform for aspiring food technologists to advance their academic and professional careers.</p>
    ...
    <div class="gnc-bento-container">
        ...
        <div class="right-stack">
            ...
            <div class="gnc-bento-item bg-light-grey" style="flex: 1;" data-aos="fade-right" data-aos-duration="800">
                ...
                <p>Admission to the M.Sc. Food Technology program at Guru Nanak College, Dehradun, typically involves a merit-based selection process. Candidates are evaluated based on their academic performance in their undergraduate degree, preferably in food technology, nutrition, microbiology, or related disciplines.</p>
                <p>The college may also conduct counseling sessions to assess the candidates' understanding of food technology and their aptitude for advanced studies in this field.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC M.Sc. Food Technology Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Food Technology (M.Sc. Food Technology)</h3>
                <p>Graduates of the M.Sc. Food Technology program can pursue a wide range of career opportunities in the food industry, which is one of the largest and most essential industries globally. They can work in food manufacturing and processing companies, quality assurance, research and development, and food safety management.</p>
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">M.Sc. Food Tech Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Manufacturing & Processing:</b> Working in large-scale food manufacturing and processing companies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Quality & Safety:</b> Roles as quality control managers, safety auditors, and QA specialists.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>R&D:</b> Focusing on the research and development of new food products and technologies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Government Regulation:</b> Opportunities in government agencies for food regulation and inspection.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Entrepreneurship:</b> Starting food processing units or specialized food industry consulting businesses.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Research & Academia:</b> Pursuing a Ph.D. for high-level research roles and academic teaching positions.</div>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="why-join-content">
                    ...
                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive and up-to-date curriculum that covers all essential aspects of food technology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Access to modern laboratories and facilities for practical training in food processing and analysis.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced faculty with expertise in various domains of food science and technology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Opportunities for internships and industry projects, providing real-world experience and professional networking.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A focus on innovative approaches to food technology and problem-solving skills.</p>
                            </div>
                        </li>
                    </ul>
