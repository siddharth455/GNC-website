                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/7grEw7LHZ0Q?autoplay=1&mute=1&playlist=7grEw7LHZ0Q&loop=1"
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/agri-image.webp" alt="agriculture image" loading="lazy" decoding="async" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Science in Agriculture</h2>
                            </div>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                <li>Admission to the B.Sc. Agriculture program at Guru Nanak College, Dehradun, is based on a merit system.</li>
                <li>The selection process considers the marks obtained in the qualifying examination. Prospective students are also required to undergo a counseling process, which assesses their interest and aptitude for a career in agriculture.</li>
            </ul>
        </div>
    </section>
                    ...
                    <div class="bigInfo-section__content pb-5">
                        ...
                        <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                            ...
                            <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-4">
                                ...
                                <li>We emphasize value-based education, focusing on cultivating critical thinking, problem-solving abilities, and a strong foundation in research and innovation. Recognizing the ever-evolving nature of the agricultural sector, we provide thorough placement training and career guidance to ensure our graduates are well-prepared to excel in diverse roles within the agriculture industry.</li>
                            </ul>
