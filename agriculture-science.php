                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Science in Agriculture </small></h3>
                                </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best B.sc Agriculture College in Dehradun, Uttarakhand</h2>
                <p>The Bachelor of Science in Agriculture (B.Sc. Agriculture) is an essential undergraduate
                            program for those interested in the vast and dynamic field of agriculture. This four-year course at Guru
                            Nanak College, The Best B.Sc Agriculture College in Dehradun, Uttarakhand is designed to provide an indepth understanding of agricultural sciences and the latest technologies used in the sector. The
                            curriculum encompasses a wide range of subjects including crop production, agricultural economics,
                            horticulture, animal husbandry, and soil science.</p>
                        <p>Students enrolled in the B.Sc. Agriculture program at the GNC Dehradun will acquire comprehensive
                            knowledge of various agricultural practices, sustainable farming methods, and the management of
                            natural resources. The course also covers important aspects like agricultural biotechnology, agribusiness
                            management, and environmental sustainability. Practical exposure through field work, internships, and
                            projects forms a crucial part of the learning experience, ensuring that students are well-equipped to
                            tackle real-world challenges in agriculture.
                        </p>
    ...
    <div class="gnc-bento-container">
        ...
        <div class="right-stack">
            ...
            <div class="gnc-bento-item bg-light-grey" style="flex: 1;" data-aos="fade-right" data-aos-duration="800">
                ...
                <p>Admission to the B.Sc. Agriculture program at Guru Nanak College, Dehradun, is based on a merit system.</p>
                <p>The selection process considers the marks obtained in the qualifying examination. Prospective students are also required to undergo a counseling process, which assesses their interest and aptitude for a career in agriculture.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC B.Sc. Agriculture Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Agriculture (B.Sc. Agriculture)</h3>
                <p>Graduates of the B.Sc. Agriculture program have a multitude of career opportunities in the agricultural sector. They can pursue roles in agricultural research and development, focusing on improving crop yields and developing sustainable farming practices. There is a growing demand for agriculture specialists in government and private sectors for roles in policy development, agricultural extension services, and agribusiness management.</p>
                
                <p>Opportunities also exist in the fields of horticulture, soil science, and animal husbandry. Graduates can become entrepreneurs in the agriculture sector, starting their own ventures in organic farming, agri-tech, or agri-marketing. Further studies in the field can lead to specialized roles in agricultural research, education, or advanced positions in agricultural management.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">B.Sc. Agriculture Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Research & Development:</b> Focusing on improving crop yields and developing sustainable farming practices.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Public & Private Sectors:</b> Roles in policy development, extension services, and agribusiness management.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Specialized Sciences:</b> Opportunities in the fields of horticulture, soil science, and animal husbandry.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Entrepreneurship:</b> Starting independent ventures in organic farming, agri-tech, or agri-marketing.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Education & Research:</b> Pursuing specialized roles in agricultural research and academic education.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Advanced Management:</b> Qualifying for high-level leadership positions in agricultural management.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For B.Sc Agriculture in Dehradun ?</h3>
                    <p>The B.Sc. Agriculture program at Guru Nanak College is a preferred choice for several reasons:</p>

                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive library with a vast collection of resources on agricultural sciences.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Advanced laboratories and experimental fields equipped with modern agricultural tools and technology for hands-on learning.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced and dedicated faculty with expertise in various domains of agriculture.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A blend of theoretical knowledge and practical skills, enriched with field trips, workshops, and guest lectures by industry experts.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">We emphasize value-based education, focusing on cultivating critical thinking, problem-solving abilities, and a strong foundation in research and innovation.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Recognizing the importance of career readiness, we provide extensive placement training to prepare our students for successful careers in the pharmaceutical and healthcare sectors.</p>
                            </div>
                        </li>
                    </ul>
                    
                    <p class="text-white">Recognizing the ever-evolving nature of the agricultural sector, we provide thorough placement training and career guidance to ensure our graduates are well-prepared to excel in diverse roles within the agriculture industry.</p>
