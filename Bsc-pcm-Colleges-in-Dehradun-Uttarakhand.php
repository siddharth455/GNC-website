...
<body>
  ...
  <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/phy-1.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Science in PCM </small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                                <a href="upload/pdf/BSc-PCM.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best B.sc PCM College in Dehradun, Uttarakhand</h2>
                <p>The Bachelor of Science in Physics, Chemistry, and Mathematics (B.Sc. PCM) is a cornerstone
                       program at the confluence of essential natural sciences, offered at the Guru Nanak College - Best B.Sc.
                       PCM College in Dehradun, Uttarakhand. This three-year undergraduate course is meticulously crafted to
                        provide students with an expansive understanding of the theoretical foundations and practical
                        applications spanning the realms of physics, chemistry, and mathematics. The integration of these
                        pivotal disciplines within the B.Sc. PCM framework is designed to equip students with analytical
                        prowess, problem-solving capabilities, and research acumen vital for spearheading scientific and
                        technological progress</p>
                        <p>The curriculum of the B.Sc. PCM program is thoughtfully structured to encompass a broad spectrum of
                         subjects. Physics courses delve into the intricacies of classical mechanics, quantum mechanics, and
                         thermodynamics, offering insight into the fundamental laws that govern the universe. The chemistry
                         segment unfolds through an in-depth exploration of organic, inorganic, and physical chemistry, each
                         area shedding light on the molecular underpinnings of matter and its transformations. The mathematics
                         curriculum traverses from foundational algebra and calculus to advanced explorations in differential
                         equations and statistics, equipping students with the mathematical tools essential for rigorous scientific analysis and breakthrough innovations.</p>
                       <p>Augmented by applied courses and electives, the program extends into interdisciplinary domains such as
                        computational physics, chemical informatics, and mathematical modeling, thereby broadening the
                         professional vistas for graduates. Guru Nanak College in Dehradun, Uttarakhand, stands out as the
                         premier institution for aspiring scientists to pursue their B.Sc. PCM degree.</p>
            ...
            <div class="hero-image-right">
                <img src="upload/infra/life-allied.webp" alt="Bsc Nursing Showcase">
            </div>
            ...
            <div class="flex-container">
                ...
                <div class="col-data">
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">The students who have passed 10+2 or had given senior secondary examination with Maths/Biology/Agriculture from any recognized board.<br>The minimum percentage required is 45% for GENERAL/OBC and 40% for ST/SC.</p>
                ...
                <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/N6Tgs5nkgqE?autoplay=1&mute=1&playlist=N6Tgs5nkgqE&loop=1" title="BSC PCMy Program Video" allowfullscreen></iframe>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC B.Sc. PCM Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Physics, Chemistry, Mathematics (B.Sc. PCM)</h3>
                <p>Graduates from B.Sc. PCM graduates are well-equipped for careers in research, engineering, information technology, and educational sectors. </p>
                
                <p>These programs also lay a strong foundation for students wishing to pursue higher studies and specialized research roles.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">B.Sc. PCM Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Research:</b> Engaging in scientific inquiry and developmental projects in various labs.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Engineering:</b> Applying mathematical and physical principles to technical and industrial roles.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Information Technology:</b> Pursuing technical careers in software, data analysis, and IT sectors.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Educational Sectors:</b> Opportunities in teaching and academic administration at various levels.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Higher Studies:</b> A strong foundation for pursuing M.Sc., Ph.D., or other professional specializations.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Specialized Research:</b> Advancing into high-level research roles within specialized scientific domains.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Science in Physics, Chemistry, Mathematics (B.Sc PCM ) in Dehradun?</h3>
                    <p>The B.Sc. PCM program at Guru Nanak College is a preferred choice for several reasons:</p>

                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A balanced and rigorous curriculum covering theoretical knowledge with practical application.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Access to well-equipped laboratories and modern facilities for practical experiments and research.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced and highly qualified faculty in each discipline.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A focus on fostering analytical thinking, problem-solving skills, and a deep understanding of scientific principles.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Opportunities for internships, projects, and research that provide practical experience and enhance understanding.</p>
                            </div>
                        </li>
                    </ul>
                    
                    <p class="text-white">The program is designed to lay a solid foundation in the core sciences, preparing students for a range of professional opportunities or for further studies in their chosen fields. With comprehensive academic support and career counseling, students are well-equipped to pursue successful careers in the sciences or related disciplines.</p>
