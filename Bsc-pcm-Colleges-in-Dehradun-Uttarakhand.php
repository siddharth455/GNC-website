...
equations and statistics, equipping students with the mathematical tools essential for rigorous scientific
analysis and breakthrough innovations.</p>
...
premier institution for aspiring scientists to pursue their B.Sc. PCM degree.</p>
                        ...
                        <p>Graduates from B.Sc. PCM graduates are well-equipped for careers in research, engineering, information technology, and educational sectors. These programs also lay a strong foundation for students wishing to pursue higher studies and specialized research roles.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/N6Tgs5nkgqE?autoplay=1&mute=1&playlist=N6Tgs5nkgqE&loop=1"
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Science in Physics, Chemistry, Mathematics <br>(B.Sc. PCM)</h2>
                            </div>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                <li>Admissions to the B.Sc. PCM programs at Guru Nanak College are based on academic performance, particularly in the 10+2 science subjects.</li>
                <li>The college may conduct counseling to further assess candidates' aptitude and interest in the subject.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        ...
                        <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                            <li>A balanced and rigorous curriculum covering theoretical knowledge with practical application.</li>
                            <li>Access to well-equipped laboratories and modern facilities for practical experiments and research.</li>
                            <li>Experienced and highly qualified faculty in each discipline.</li>
                            <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-4">
                                <li>A focus on fostering analytical thinking, problem-solving skills, and a deep understanding of scientific principles.</li>
                                <li>Opportunities for internships, projects, and research that provide practical experience and enhance understanding.</li>
