...
<head>
    ...
    <title>Guru Nanak College | Best B.Sc Microbiology College in Dehradun Uttarakhand</title>
...
<body>
  ...
  <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/13.webp'); background-repeat: no-repeat; background-size: cover;">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                ...
                                <a href="upload/pdf/BSc-Microbiology.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
            ...
            <div class="flex-container">
                ...
                <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/Bqyd4n_xGmY?autoplay=1&mute=1&playlist=Bqyd4n_xGmY&loop=1" title="BSC Microbiology Program Video" allowfullscreen></iframe>
                    </div>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC B.Sc. Microbiology Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">Microbiology Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Healthcare & Diagnostics:</b> Working as clinical microbiologists to identify pathogens and develop treatments.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Pharma & Research:</b> Pursuing roles in clinical research organizations and pharmaceutical companies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Industrial Sectors:</b> Opportunities in the food and beverage industries and agricultural sectors.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Scientific Research:</b> Contributing to genetics, biochemistry, and molecular biology in research institutions.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Environmental Agencies:</b> Focusing on environmental monitoring and bioremediation initiatives.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Academia:</b> Pursuing advanced studies for research-based or academic teaching careers.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Science in Microbiology in Dehradun?</h3>
                    ...
                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive curriculum that encompasses various branches of microbiology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">State-of-the-art laboratory facilities for practical training and research.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A faculty team of experienced academicians and professionals in microbiology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Opportunities for student-led research projects and internships in relevant industries.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Interactive learning through seminars, workshops, and guest lectures by experts in the field.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Understanding the significance of career preparedness, we provide comprehensive placement training, equipping our students for thriving careers in the Microbiology and healthcare sectors.</p>
                            </div>
                        </li>
                    </ul>
