...
<body>
    ...
    ?>
       <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/04.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Science in Geology </small></h3>
                                </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best B.sc Geology College in Dehradun, Uttarakhand</h2>
                 <p>The Bachelor of Science in Geology program at the Guru Nanak College, Dehradun is an
undergraduate course designed for students fascinated by the study of the Earth, its materials,
processes, history, and its impact on humans and life. This three-year program provides a
comprehensive understanding of various geological concepts including mineralogy, petrology,
paleontology, stratigraphy, and structural geology.</p>
                        <p>Students enrolled in the B.Sc. Geology program will explore the physical properties of the Earth’s
substances, the processes that lead to the formation and alteration of these materials, and the history
of the planet and its life forms as recorded in rocks. The course also covers areas such as environmental
geology, hydrogeology, and geophysics, offering students a broad perspective on how geology interacts
with other scientific fields.</p>
<p>Guru Nanak College - Best B.Sc Geology College in Dehradun, Uttarakhand provides an exceptional
platform for aspiring geologists to gain both theoretical knowledge and practical skills in the field of
geology.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC B.Sc. Geology Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Geology (B.Sc. Geology)</h3>
                <p>Graduates of the B.Sc. Geology program have a wide range of career options in industries such as oil and gas, mining, environmental consulting, and civil engineering. They can work as geologists in exploration and production, environmental assessment, natural hazard monitoring, and water resource management.</p>
                
                <p>Opportunities also exist in government agencies and research institutions, focusing on areas like geological surveying, environmental protection, and resource management. Further studies in geology or related disciplines can lead to advanced roles in research, academia, or specialized fields such as paleontology, seismology, or volcanology.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">B.Sc. Geology Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Energy & Mining:</b> Professional roles in the oil and gas industry and mineral exploration/production.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Environmental Consulting:</b> Conducting environmental assessments and resource management.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Civil Engineering:</b> Applying geological principles to construction and infrastructure projects.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Natural Hazard Monitoring:</b> Working in disaster mitigation and monitoring natural geological hazards.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Government & Research:</b> Roles in geological surveying and environmental protection agencies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Specialized Research:</b> Advanced careers in fields like paleontology, seismology, or volcanology.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Science in Geology (BSc Geology) in Dehradun?</h3>
                    <p>The B.Sc. Geology program at Guru Nanak College is a preferred choice for several reasons:</p>

                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive curriculum that covers fundamental and advanced topics in geology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Access to modern laboratories and equipment for practical training in geological analysis and research.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced faculty with expertise in various geology sub-disciplines.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Field trips and geological excursions that provide hands-on experience and exposure to real-world geological phenomena.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A focus on developing critical thinking, analytical skills, and a practical approach to problem-solving in geology.</p>
                            </div>
                        </li>
                    </ul>
                    
                    <p class="text-white">The program is designed to provide students with a strong foundation in geology, preparing them for successful careers in various geology-related industries or for further studies in geosciences. With dedicated academic support and career counseling, students are well-equipped to pursue their professional goals in the field of geology.</p>
