                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/2WRnL8PrtPc?autoplay=1&mute=1&playlist=2WRnL8PrtPc&loop=1"
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Science in Geology</h2>
                            </div>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                <li>Admission to the B.Sc. Geology program at Guru Nanak College, Dehradun, is based on academic merit.</li>
                <li>The selection process typically involves evaluating the candidate's marks in their 10+2 examination, with a focus on science subjects. The college may also conduct counseling sessions to assess the candidates' interest in geology and their aptitude for the field.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        ...
                        <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                            <li>A comprehensive curriculum that covers fundamental and advanced topics in geology.</li>
                            <li>Access to modern laboratories and equipment for practical training in geological analysis and research.</li>
                            <li>Experienced faculty with expertise in various geology sub-disciplines.</li>
                            <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-4">
                                <li>Field trips and geological excursions that provide hands-on experience and exposure to real-world geological phenomena.</li>
                                <li>A focus on developing critical thinking, analytical skills, and a practical approach to problem-solving in geology.</li>
