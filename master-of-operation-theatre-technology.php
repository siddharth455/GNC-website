...
<head>
    ...
    <title> Guru Nanak College | Best Master of Operation Theatre Technology college in Dehradun,Uttarakhand.</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Enroll in the leading Master of Operation Theatre Technology program at Guru Nanak College in Dehradun, Uttarakhand. With advanced training, expert faculty, and hands-on experience, GNC prepares students for rewarding careers in surgical and OT support.">
    <link rel="canonical" href="https://gnc.edu.in/master-of-operation-theatre-technology>
    ...
    <meta property="og:description" content="Enroll in the leading Master of Operation Theatre Technology program at Guru Nanak College in Dehradun, Uttarakhand. With advanced training, expert faculty, and hands-on experience, GNC prepares students for rewarding careers in surgical and OT support." />
    <meta property="og:url" content="https://gnc.edu.in/master-of-operation-theatre-technology" />
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/ott-banner.webp'); background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Guru Nanak College - Best Master of Operation Theatre Technology (MOTT) College in India</h2>
                        </div>
                        ...
                        <p>
                        Graduates of the Master of Operation Theatre Technology (MOTT) have a wide range of career opportunities in the healthcare sector. As senior Operation Theatre Technologists, they play a key role in assisting surgeons and anesthesiologists, managing advanced surgical equipment, and maintaining sterile conditions in operation theatres. Their expertise also extends to roles such as Surgical Equipment Specialists, where they oversee the maintenance, calibration, and operation of complex surgical instruments, ensuring optimal functionality in critical procedures.</p>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/ott.webp" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Master of Operation Theatre Technology (MOTT)</h2>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <li>Bachelor's degree in OTT (B. OTT) or equivalent from a recognized university.</li>
