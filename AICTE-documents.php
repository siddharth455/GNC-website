    ...
    <div class="container ">
        <div class="card mt-2 mb-2">
            <div class="card-header  text-white" style="background-color: #00bcfb;">
                <h2 style="text-align: center;">AICTE Documents</h2>
            </div>
                ...
                <div class="col-md-8 col-12">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                            <h4 style="text-align: center;">Mandatory Disclosure</h4>
                            <div class="pdf-container">
                                <embed src="assets/images/Sharon.pdf#page=1" type="application/pdf" width="100%" height="100%">
                            </div>
                        </div>
                        <div class="tab-pane fade show" id="v-pills-UGC" role="tabpanel" aria-labelledby="v-pills-UGC-tab" tabindex="0">
                            <h4 style="text-align: center;">Letter of Approval (L.O.A.) (2024-25)</h4>
                            <div class="pdf-container">
                                <embed src="upload/infra/Letter-of-Approval-(2024-2025).pdf#page=1" type="application/pdf" width="100%" height="100%">
                            </div>
                        </div>
                        <div class="tab-pane fade show" id="v-pills-MSME" role="tabpanel" aria-labelledby="v-pills-MSME-tab" tabindex="0">
                            <h4 style="text-align: center;">Extension of Approval (E.O.A.) 1. 2025-26</h4>
                            <div class="pdf-container">
                                <embed src="upload/infra/EOA-Report-(2025-2026).PDF#page=1" type="application/pdf" width="100%" height="100%">
                            </div>
                        </div>
                        <div class="tab-pane fade show" id="v-pills-HNBGMU" role="tabpanel" aria-labelledby="v-pills-HNBGMU-tab" tabindex="0">
                            <h4 style="text-align: center;">AICTE Essential Documents</h4>
                            <div class="pdf-container">
