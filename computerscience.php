...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://www.gnc.edu.in/computerscience">
</head>
<body>
    ...
    <div class="swiper banner-slider">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="assets/image/banner-2.webp" alt="DIS Mobile Banner" class="banner-image w-100" width="auto" height="auto">
...
<section class="kc-scholarship-benefits" aria-labelledby="kc-scholarship-title">
 ...
 <section id="programs" class="py-5 ">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold text-white" data-aos="fade-up">Our Computer Science Schools Course</h2>

    <!-- Filter Buttons -->
     <div class="text-center mb-4" data-aos="fade-up" data-aos-delay="100">
      <!-- <div class="btn-group flex-wrap">
        <button class="btn btn-outline-primary filter-btn active" data-filter="cs">Computer Science</button>
      </div> -->
    </div>
...
<script>
  ...
  const showMoreSchools = ["cs"];
  let currentFilter = 'cs';
