                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                               ...
                               <a href="upload/pdf/BCA.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-image-right">
                <img src="upload/infra/bca.webp" alt="BCA Showcase">
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">BCA Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Development:</b> Working as software developers, web developers, and system analysts.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Administration:</b> Specialized roles in network administration and database management.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Sectoral Roles:</b> Opportunities in finance, government agencies, education, and healthcare.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Entrepreneurship:</b> Venturing into the tech industry through the burgeoning startup culture.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>MCA Pathway:</b> Pursuing a Master of Computer Applications for specialized IT expertise.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Management:</b> Advancing to leadership roles through an MBA (Master of Business Administration).</div>
                    </li>
                </ul>
            </div>
        </div>
