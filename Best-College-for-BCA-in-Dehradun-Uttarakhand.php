...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/cs-5.webp'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>Graduates of the BCA program have a plethora of career opportunities in the IT and software industry. They can pursue roles as software developers, web developers, system analysts, network administrators, and database administrators. The demand for BCA graduates extends across various sectors, including IT companies, financial institutions, government agencies, education sectors, and healthcare. With the burgeoning startup culture, there are also ample opportunities for entrepreneurship in the tech industry. Further studies, such as an MCA (Master of Computer Applications) or an MBA (Master of Business Administration), can lead to higher positions in management and specialized areas of IT.</p>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-12 about-program-image">
                        <img src="upload/infra/bca.webp" alt="bca showcase" loading="lazy" style="width: -webkit-fill-available;">
                    </div>
                </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Computer Applications (BCA)</h2>
                            </div>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                <li>Admission to the BCA program at Guru Nanak College, Dehradun, is typically based on academic merit.</li>
                <li>Candidates are evaluated based on their performance in the 10+2 examination, preferably with Mathematics as a subject. The college may also conduct interviews or entrance tests to assess the candidates' aptitude for computer applications and their problem-solving skills.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        ...
                        <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                            <li>A comprehensive curriculum that is aligned with current industry trends and requirements.</li>
                            <li>State-of-the-art computer labs and IT infrastructure for practical training and projects.</li>
                            <li>Experienced faculty with expertise in the latest technologies and applications.</li>
                            <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-4">
                                <li>Opportunities for internships and industry projects that provide real-world experience and professional networking.</li>
                                <li>A focus on both technical and soft skills development, ensuring well-rounded professional growth.</li>
                                <li>The program is designed to equip students with the necessary skills and knowledge to succeed in the fast-paced world of computer applications. With a blend of theoretical understanding and practical exposure, graduates are well-prepared for the challenges and opportunities in the IT industry or for further studies in this field.</li>
                            </ul>
