...
<head>
    ...
    <meta name="description" content="Guru Nanak College, Dehradun's leading institution for a Master of Public Health. With a comprehensive curriculum, top-tier faculty, and cuttingedge research opportunities, Guru Nanak College equips future public health leaders with the knowledge and skills to make a global impact.">
    ...
    <meta property="og:description" content="Guru Nanak College, Dehradun's leading institution for a Master of Public Health. With a comprehensive curriculum, top-tier faculty, and cuttingedge research opportunities, Guru Nanak College equips future public health leaders with the knowledge and skills to make a global impact." />
...
<body>
  ...
  <section class="pageBanner-inner">
        <div style="background-image: url('upload/master-of-public-health-head.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                ...
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                 ...
                                 <a href="upload/pdf/MPH.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best Master of Public Health (MPH) College in Dehradun, Uttarakhand</h2>
                
                          <p>The Master of Public Health (MPH) at Guru Nanak College - Best Master of Public Health
...
provide students with a comprehensive understanding of public health principles and practices.</p>
            ...
            <div class="hero-image-right">
                <img src="upload/master-of-health-science.webp" alt="GNC Pharmacy Showcase">
            </div>
    ...
    <section class="gnc-bmrit-section py-5" style="background-color: #ffffff; color: var(--text-dark);">
                ...
                <div class="col-data">
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">Minimum qualification required is graduation in health science or any related field from a recognized university. Min. 50% marks for general and 45% marks in case of SC/ST category.</p>
        ...
        <div class="col-video">
                    <!-- <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/3bVTeWA9mjU?autoplay=1&mute=1&playlist=3bVTeWA9mjU&loop=1" title="D.Pharm Program Video" allowfullscreen></iframe> -->
                    </div> 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC D.Pharm Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">D.Pharm Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Pharmacy Technicians:</b> Supporting pharmacists in dispensing medications and providing patient care.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Medical Representatives:</b> Promoting and selling pharmaceutical products to healthcare professionals.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Research:</b> Working as assistants to help manage and execute clinical trials.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Manufacturing:</b> Roles in drug production ensuring high standards of pharmaceutical products.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Quality Control:</b> Monitoring and testing products to ensure safety and efficacy.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Healthcare Support:</b> Providing essential technical services within the healthcare sector.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Master of Public Health (MPH) in Dehradun?</h3>
