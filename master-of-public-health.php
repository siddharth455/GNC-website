...
<head>
    ...
    <title>Guru Nanak College | Best Master of Public Health College in Dehradun Uttarakhand</title>
...
provide students with a comprehensive understanding of public health principles and practices.</p>
                        ...
                        <p>After completing a Master of Public Health (MPH), graduates have diverse career options in public, private, and non-profit sectors. They can work as epidemiologists, health policy analysts, public health educators, environmental health scientists, biostatisticians, public health administrators, and healthcare consultants. These roles involve disease prevention, health promotion, policy development, and research, addressing health challenges on various scales. The MPH also provides a strong foundation for further academic pursuits, including doctoral studies. MPH graduates often find opportunities in global health, working with international organizations to address health disparities worldwide. They also have the potential to lead initiatives in non-governmental organizations (NGOs), focusing on community health programs, health advocacy, and policy implementation. These paths allow MPH holders to have a significant impact on public health both locally and globally.</p>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/master-of-health-science.webp" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Master of Public Health (MPH)</h2>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <li>Minimum qualification required is graduation in health science or any related field from a recognized university.</li>
