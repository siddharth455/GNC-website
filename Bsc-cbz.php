                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/GYfTrZM7YrA?autoplay=1&mute=1&playlist=GYfTrZM7YrA&loop=1"
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/life-allied.webp" alt="cbz showcasing" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Science in Chemistry, Botany, Zoology <br>(B.Sc. CBZ)</h2>
                            </div>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                <li>Admissions to both the B.Sc. CBZ programs at Guru Nanak College are based on academic performance, particularly in the 10+2 science subjects.</li>
