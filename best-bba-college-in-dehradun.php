            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>Graduates of the BBA program have diverse career opportunities in various sectors, including corporate businesses, financial institutions, marketing agencies, and governmental organizations. They can pursue roles in management, sales, marketing, human resources, and finance. The BBA degree also serves as a stepping stone for entrepreneurial ventures, enabling graduates to start their own businesses or manage family-owned enterprises. Additionally, graduates can opt for higher studies such as an MBA (Master of Business Administration), which can lead to advanced career prospects in business management and leadership.</p>
                    ...
                    <div class="row">
                        <!-- <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/blzvFKeZAWA?autoplay=1&mute=1&playlist=blzvFKeZAWA&loop=1"
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        <div class="page-heading">
                            <h3>Why Join Guru Nank College For BBA in Dehradun ?</h3>
                        </div>
                        <p>The BBA program at Guru Nanak College stands out for several reasons:</p>
                        <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                            <li>A comprehensive and updated curriculum that provides a strong foundation in various business disciplines.</li>
                            <li>Experienced faculty with industry and academic expertise to guide students in understanding real-world business scenarios.</li>
                            <li>Opportunities for practical learning through case studies, projects, internships, and industry interactions.</li>
                            <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-4">
                                <li>Development of entrepreneurial and leadership skills to prepare students for managerial roles and business ventures.</li>
                                <li>A focus on holistic development, including soft skills training and personality development programs.</li>
                            </ul>
