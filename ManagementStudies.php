...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://gnc.edu.in/ManagementStudies">
</head>
<body>
    ...
    <div class="swiper banner-slider">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="assets/image/banner-9.webp" alt="DIS Mobile Banner" class="banner-image w-100" width="auto" height="auto">
...
<section class="kc-scholarship-benefits" aria-labelledby="kc-scholarship-title">
 ...
 <section id="programs" class="py-5 ">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold text-white" data-aos="fade-up">Our Hotel Management Course</h2>

    <!-- Filter Buttons -->
     <div class="text-center mb-4" data-aos="fade-up" data-aos-delay="100">
      <!-- <div class="btn-group flex-wrap">
        <button class="btn btn-outline-primary filter-btn active" data-filter="hotel">Hotel Management</button>
      </div> -->
    </div>
    ...
    <div class="row g-4 course-container">
      ...
      <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">1 Year | Fee: ₹45,000/year (Included Power Degree Fee)</p>
...
<script>
  ...
  const showMoreSchools = ["hotel"];
  let currentFilter = 'hotel';
