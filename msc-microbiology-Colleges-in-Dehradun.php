...
platform for aspiring microbiologists to advance their academic and professional careers.
                        ...
                        <p>Graduates of the M.Sc. Microbiology program can pursue a variety of career paths in the scientific and healthcare sectors. They can work in pharmaceutical companies, research institutions, clinical diagnostic laboratories, and public health organizations. Roles may include research scientists, microbiologists, clinical laboratory technologists, and biotechnologists. There are also opportunities in academia and education for those interested in teaching and research. Further, graduates can play a vital role in industries such as food and beverage, agriculture, and environmental management, focusing on quality control, product development, and bioremediation.</p>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Master of Science in Microbiology</h2>
                            </div>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                <li>Admission to the M.Sc. Microbiology program at Guru Nanak College, Dehradun, typically involves a merit-based selection process, considering the candidate’s academic performance in their undergraduate degree, preferably in a relevant field such as microbiology, biology, or biochemistry.</li>
                <li>The college may also conduct counseling sessions to assess the candidates' knowledge and aptitude for advanced studies in microbiology.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        ...
                        <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
                            <li>A comprehensive and updated curriculum that covers both traditional and modern aspects of microbiology.</li>
                            <li>Advanced laboratory facilities for practical training and research.</li>
                            <li>Faculty comprising experienced academicians and researchers with expertise in various microbiology sub-disciplines.</li>
                            <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-4">
                                <li>Opportunities for students to engage in research projects, internships, and industry visits.</li>
                                <li>Emphasis on developing analytical and research skills, preparing students for various roles in the microbiology field.</li>
                            </ul>
                            <li>The program is designed to equip students with the necessary skills and knowledge for a successful career in microbiology or for further research and academic pursuits. With a strong emphasis on practical experience and industry relevance, graduates are well-prepared to meet the challenges and opportunities in the diverse field of microbiology.</li>
                        </ul>
