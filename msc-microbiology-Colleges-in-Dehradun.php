...
<body>
    ...
    ?>
       <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/10.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Science in Microbiology </small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                                <a href="upload/pdf/MSc-Microbiology.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best M.Sc Microbiology College in Dehradun, Uttarakhand</h2>
                 <p>The Master of Science in Microbiology program at Guru Nanak College, Dehradun is a
postgraduate course crafted for students who wish to deepen their understanding and expertise in the
field of microbiology. This two-year program offers advanced study of microorganisms and their
interactions with humans, animals, plants, and the environment. The curriculum encompasses various
areas of microbiology such as bacterial and viral genetics, immunology, environmental microbiology,
and industrial microbiology.</p>
                        <p>The M.Sc. Microbiology course is structured to blend theoretical knowledge with practical laboratory
skills. It covers advanced topics like molecular biology techniques, microbial pathogenesis, microbial
biotechnology, and bioinformatics. Students also engage in research projects, which are crucial for
gaining hands-on experience in microbiological investigations and techniques.</p>
<p>Guru Nanak College - Best M.Sc Microbiology College in Dehradun, Uttarakhand provides an exceptional
platform for aspiring microbiologists to advance their academic and professional careers.
</p>
                ...
                <div class="col-data">
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">Minimum qualification required is graduation in any stream of Life Science from any recognized university.<br>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC M.Sc. Microbiology Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Microbiology (M.Sc. Microbiology)</h3>
                <p>Graduates of the M.Sc. Microbiology program can pursue a variety of career paths in the scientific and healthcare sectors. They can work in pharmaceutical companies, research institutions, clinical diagnostic laboratories, and public health organizations. Roles may include research scientists, microbiologists, clinical laboratory technologists, and biotechnologists.</p>
                
                <p>There are also opportunities in academia and education for those interested in teaching and research. Further, graduates can play a vital role in industries such as food and beverage, agriculture, and environmental management, focusing on quality control, product development, and bioremediation.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">M.Sc. Microbiology Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Pharma & Biotech:</b> Working as research scientists and microbiologists in pharmaceutical companies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Diagnostics:</b> Roles as clinical laboratory technologists in diagnostic and research labs.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Public Health:</b> Contributing to public health organizations and healthcare monitoring.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Academia:</b> Opportunities in education and scientific teaching for those interested in research.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Food & Agriculture:</b> Focus on quality control and product development in the industrial sector.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Environmental Mgmt:</b> Specialized roles focusing on bioremediation and environmental safety.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Master of Science in Microbiology in Dehradun?</h3>
                    <p>The M.Sc. Microbiology program at Guru Nanak College offers several advantages:</p>

                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive and updated curriculum that covers both traditional and modern aspects of microbiology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Advanced laboratory facilities for practical training and research.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Faculty comprising experienced academicians and researchers with expertise in various microbiology sub-disciplines.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Opportunities for students to engage in research projects, internships, and industry visits.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Emphasis on developing analytical and research skills, preparing students for various roles in the microbiology field.</p>
                            </div>
                        </li>
                    </ul>
                    
                    <p class="text-white">The program is designed to equip students with the necessary skills and knowledge for a successful career in microbiology or for further research and academic pursuits. With a strong emphasis on practical experience and industry relevance, graduates are well-prepared to meet the challenges and opportunities in the diverse field of microbiology.</p>
