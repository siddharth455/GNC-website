...
<section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/26.webp'); background-repeat: no-repeat; background-size: cover;">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                ...
                                <a href="upload/pdf/BSc-Biotechnology.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
            ...
            <div class="flex-container">
                ...
                <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/n0c47oY24EM?autoplay=1&mute=1&playlist=n0c47oY24EM&loop=1" title="BSC Biotechnology Program Video" allowfullscreen></iframe>
                    </div>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC B.Sc. Biotechnology Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Biotechnology (B.Sc. Biotechnology)</h3>
                ...
                <p>Opportunities exist in research institutions and academic settings, where graduates can engage in research projects or pursue higher education in biotechnology or related fields. Biotechnologists are also in demand in the environmental sector, working on bio-remediation and waste management. Additionally, the food industry, forensic science, and clinical research organizations offer various roles for biotechnology graduates.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">Biotechnology Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Pharma & Biotech:</b> R&D roles focused on the development of new drugs, vaccines, and products.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Agri-Biotechnology:</b> Developing genetically modified crops and effective biopesticides.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Research & Academia:</b> Engaging in scientific research projects or pursuing advanced higher education.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Environmental Sector:</b> Specialized roles in bio-remediation and sustainable waste management.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Food & Forensics:</b> Diverse career roles within the food industry and forensic science sectors.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Research:</b> Opportunities in CROs managing clinical trials and biotechnological studies.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Science in Biotechnology in Dehradun?</h3>
                    ...
                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div class="ms-3">
                                <p class="mb-0">A curriculum that is up-to-date with the latest developments in the field of biotechnology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">State-of-the-art laboratories equipped with modern biotechnological instruments and facilities for hands-on training.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced faculty members who are experts in various sub-disciplines of biotechnology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Opportunities for students to participate in research projects, workshops, and internships with biotech companies and research institutions.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A focus on practical skills development, critical thinking, and problem-solving to prepare students for the challenges of the biotechnology sector.</p>
                            </div>
                        </li>
                    </ul>
                    
                    <p class="text-white">The program aims to produce graduates who are not only knowledgeable in biotechnological theories and techniques but also capable of applying this knowledge in practical and innovative ways. With comprehensive academic support and career guidance, students are well-prepared for a successful career in biotechnology or for further studies in this exciting and rapidly evolving field.</p>
