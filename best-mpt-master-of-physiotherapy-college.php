...
@media (max-width: 768px) {
    .career-glass-grid { grid-template-columns: 1fr; }
        ...
        .text-theme {
         ...
         .why-join-blue {
            background: linear-gradient(90deg, rgb(11, 87, 138) 30%, rgba(30, 34, 82, .1)), url('upload/programs/mpt.webp') !important;
...
<script type="application/ld+json">
{
  ...
  "description": "2-year master degree program in advanced physical therapy, orthopaedics, neurology, and musculoskeletal rehabilitation at Guru Nanak College, Dehradun.",
  "provider": {
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/mpt.webp'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 animate__animated animate__fadeIn">
                        ...
                        <h1 class="display-6 fw-300 my-1">Guru Nanak College - Best MPT(Master of Physiotherapy ) College in Dehradun, <span style="color:var(--accent)">Uttarakhand</span></h1>
                       <p class="lead text-muted">The Master of Physiotherapy (MPT) is a comprehensive two-year postgraduate
...
<p class="lead text-muted">Physiotherapy plays a pivotal role in rehabilitative health care by promoting
...
<p class="lead text-muted">Throughout the program, students are introduced to diverse specialties
...
career interests.</p>
<p class="lead text-muted">In addition to clinical proficiency, the course also emphasizes research
...
practice.</p>
<p class="lead text-muted">By the end of the program, graduates are prepared to assess, plan, and execute
...
well-being</p>
                    ...
                    <div class="premium-card text-start shadow-sm" style="border-left: 5px solid var(--accent)">
                     ...
                     <p class="fst-italic text-secondary">
                          “The MPT program is designed to provide advanced knowledge and clinical expertise in physiotherapy and rehabilitation sciences. With specialization in areas such as orthopedics, neurology, and sports physiotherapy, students are trained to deliver evidence-based treatment and lead in modern rehabilitative care practices.”
                         </p>
        ...
        <div class="container">
            <div class="flex-container">
                ...
                <div class="col-data">
                    ...
                    <a href="upload/pdf/fee/MPT.jpeg" target="_blank" id="printButton1" target="_blank" class="btn-download">Download Fee Structure</a>
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">Bachelor's degree in Medical Laboratory Technology (BMLT) or equivalent from a recognized university. Min. 50% marks for general and 45% marks in case of SC/ST category.</p>
                ...
                <!-- <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/3UhI5XswpMw?autoplay=1&mute=1&playlist=3UhI5XswpMw&loop=1" title="BSC OTT Program Video" allowfullscreen></iframe>
                    </div> -->
    ...
    <div class="container-fluid px-lg-5">
        ...
        <div class="text-center mb-5 scroll-reveal">
            <div class="text-center mb-5">
                ...
                <h2 class="display-3 fw-extrabold display-5 mb-2" style="color: #0f9af1;">Excellence Redefined</h2>
            </div>
        </div>
        ...
        <div class="row g-0 shadow-lg rounded-4 overflow-hidden border scroll-reveal">
            ...
            <div class="col-lg-7 bg-white p-4 p-md-5">
                ...
                <div class="practice-list-container">
                    <?php
                    $practices = [
                        "Advanced clinical training in specialized physiotherapy domains.",
                        "Evidence-based practice with focus on rehabilitation outcomes.",
                        "Case-based learning for complex musculoskeletal and neurological conditions.",
                        "Integration of advanced theory with hands-on clinical expertise.",
                        "Use of modern physiotherapy modalities and rehabilitation technologies.",
                        "Interdisciplinary collaboration with healthcare professionals.",
                        "Outcome-based rehabilitation planning and patient recovery tracking.",
                        "Expert faculty with strong clinical, research, and academic background."
                    ];
                ...
                <div class="assessment-quote mt-4 p-3 rounded-3 scroll-item">
                    <p class="mb-0 x-small text-muted">
                        ...
                        <strong>Assessment Methods:</strong> Advanced clinical assessments, case presentations, research projects, viva, and continuous evaluation.
                    </p>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="empower-card mb-3 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="x-small text-muted mb-0">Work with complex cases in hospitals and specialized rehabilitation centers.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="empower-card mb-3 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="x-small text-muted mb-0">Training in sports physiotherapy, neuro rehab, and manual therapy techniques.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="empower-card mb-4 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fw-bold mb-0 small">Clinical & Research Exposure</h6>
                                <p class="x-small text-muted mb-0">Collaboration with hospitals, rehab centers, and research institutions.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="empower-card mb-4 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="x-small text-muted mb-0">Focus on thesis work, clinical research, and evidence-based practice.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-2 scroll-item">
                        <div class="col-6">
                            <div class="p-2 border rounded-3 bg-white text-center">
                                <span class="d-block fw-bold text-theme h5 mb-0">12+</span>
                                <span class="x-small text-uppercase fw-bold text-muted">Rehab Labs</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-2 border rounded-3 bg-white text-center">
...
<section class="gnc-bmrit-wrapper">
    <div class="container-fluid px-lg-5">
        ...
        <div class="text-center mb-5 bmr-reveal">
            <h2 class="fw-extrabold display-5 mb-2" style="color: #0f9af1;">Career Prospects After MPT</h2>
            <p class="fw-bold text-uppercase tracking-wider" style="color: #fb7b1c;">Advance Your Career in Specialized Physiotherapy & Rehabilitation</p>
        </div>
            ...
            <div class="col-lg-6 bmr-reveal">
                <div class="career-glass-grid">
                    ...
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            <h6>Senior Physiotherapist</h6>
                            <span>Handle advanced rehabilitation cases in hospitals and clinics.</span>
                        </div>
                    </div>

                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-dumbbell"></i></div>
                        <div class="node-text">
                            <h6>Sports Physiotherapist</h6>
                            <span>Work with athletes for injury prevention and performance enhancement.</span>
                        </div>
                    </div>
                    ...
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            ...
                            <span>Specialize in treating neurological disorders and rehabilitation.</span>
                        </div>
                    </div>

                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-bone"></i></div>
                        <div class="node-text">
                            <h6>Orthopedic Physiotherapist</h6>
                            <span>Focus on musculoskeletal injuries and post-surgical recovery.</span>
                        </div>
                    </div>
                    ...
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            <h6>Rehabilitation Consultant</h6>
                            <span>Design advanced rehabilitation programs for patients.</span>
                        </div>
                    </div>
                    ...
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            <h6>Academic Lecturer / Researcher</h6>
                            <span>Teach, mentor, and contribute to physiotherapy research.</span>
                        </div>
                    </div>
                ...
                <div class="gnc-benefits-card bmr-item">
                    ...
                    <div class="benefits-content p-4">
                        <div class="benefit-row">
                            ...
                            <p><strong>Advanced Rehab Labs:</strong> Train with modern physiotherapy and rehabilitation equipment.</p>
                        </div>
                        <div class="benefit-row">
                            <i class="fa-solid fa-circle-check"></i>
                            <p><strong>Clinical Specialization:</strong> Exposure to neuro, ortho, and sports rehabilitation.</p>
                        </div>
                        <div class="benefit-row">
                            <i class="fa-solid fa-circle-check"></i>
                            <p><strong>Expert Faculty:</strong> Learn from experienced clinicians and research professionals.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Physiotherapy (MPT)</h3>
                <p>The Master of Physiotherapy (MPT) degree opens up a wide array of career opportunities in the healthcare field. MPT graduates are in high demand in hospitals, clinics, and rehabilitation centers, where they take on advanced roles in managing patient recovery after surgeries or injuries, as well as treating chronic conditions. They focus on enhancing mobility, reducing pain, and improving overall function for patients undergoing rehabilitation.</p>
                
                <p>Private practice is also a popular career path for MPT graduates. In this setting, they can offer personalized care, addressing complex musculoskeletal and neurological conditions with tailored treatment plans. This allows MPT professionals to provide specialized physiotherapy, focusing on the unique needs of each patient for more effective rehabilitation and recovery.</p>
            </div>

            
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">MPT Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Roles:</b> High demand in hospitals, clinics, and specialized rehabilitation centers.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Advanced Recovery:</b> Managing patient recovery after complex surgeries or serious injuries.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Chronic Care:</b> Specialized roles in treating and managing long-term chronic conditions.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Functional Improvement:</b> Focusing on enhancing mobility, reducing pain, and improving function.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Private Practice:</b> Offering personalized care with tailored treatment plans for patients.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Specialized Therapy:</b> Addressing complex musculoskeletal and neurological conditions.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Choose Guru Nanak College for Master of Physiotherapy (MPT) in Dehradun?</h3>
                    ...
                    <p>Our goal is to develop skilled professionals ready to face global healthcare challenges.
                       The campus is designed with advanced educational facilities, ensuring a comprehensive learning experience.</p>
                    ...
                    <ul class="check-list-white">
                        ...
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div class="ms-3">
                                <p class="mb-0">A well-stocked, centrally managed library.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Modern laboratories equipped with the latest technology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Highly qualified and experienced faculty.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Innovative teaching methods that combine traditional and modern techniques.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">We emphasize value-based education, focusing on developing critical thinking, problem-solving skills, and a capacity for innovation and research.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Recognizing the importance of career readiness, we offer extensive placement training to prepare our students for successful careers in the healthcare sector.</p>
                            </div>
                        </li>
                    </ul>
