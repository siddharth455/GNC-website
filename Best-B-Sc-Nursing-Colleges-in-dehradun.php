                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/WgPpWfNyinI?autoplay=1&mute=1&playlist=WgPpWfNyinI&loop=1"
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/nursing.webp" alt="nursing showcase" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Science in Nursing</h2>
                            </div>
