                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Science in Nursing</small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                               <a href="upload/pdf/nursing.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-image-right">
                <img src="upload/infra/nursing.webp" alt="Bsc Nursing Showcase">
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC BSc Nursing Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">BSc Nursing Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Registered Nurses (RNs):</b> Providing direct patient care in hospitals, clinics, or community centers.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Specialized Nursing:</b> Focusing on high-demand fields such as Pediatrics or Oncology with additional training.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Nursing Management:</b> Advancing to managerial roles to oversee clinical departments and policies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Public Health & Research:</b> Contributing to health initiatives, education, and pharmaceutical research.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Travel Nursing:</b> Offering healthcare services in diverse geographical locations.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Legal Nurse Consultants:</b> Providing clinical expertise to bridge the healthcare and legal sectors.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Science in Nursing (BSc Nursing) in Dehradun?</h3>
