...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
  anchor.addEventListener('click', function(e) {
    ...
    <section>
<marquee behavior="scroll" direction="left" scrollamount="6" style="background-color:#ff9c5a; color:rgb(0, 0, 0); padding: 10px; font-weight: bold; z-index:0">
   Disclaimer: This is our official website. There is no other website for any admission to Guru Nanak College, Jhajra, Dehradun. Please do not send any amount to any account other than the official one. 
    <a href="bank-details.php" style="color:rgb(255, 255, 255); text-decoration: underline;">Click here</a> for account details.
            ...
            <nav class="navbar navbar-expand-xl">
                <div class="container-fluid align-items-start">
                    <div class="navbar-brand p-0 mt-0">
                        <div class="d-flex align-items-center">
                            <a href="index.php" aria-label="Go to Guru Nanak College's Home Page">
                                <img src="images/logo.webp" alt="college logo" loading="lazy" width="196" class="me-2 cu-logo">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="mob-lower align-items-center d-lg-none">
                        <div class="header_btn blue-gradient mob-cl-btn">
                            <a href="tel:+917300900900" class="d-flex align-items-center text-white">
                                <img src="images/phone-icon.webp" alt="phone icon" loading="lazy" width="30">
                        ...
                        <!-- <ul class="header__top-right w-auto d-flex list-unstyled mob-cl-search p-0 m-0">
                            ...
                            <li class="ph-missed"><a href="tel:+917300900900" aria-label="Give a miss call"><i
                                        class="fa-solid fa-phone" style="font-size: 12px"></i><span>Call Us</span></a>
                            </li>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="upper-header">
                            <ul class="menu-options position-relative list-unstyled m-0 p-0">
                                <li><a href="https://student.gncdehradun.com/" target="_blank">Student ERP Login </a>
                                </li>
                            ...
                            <ul class="header__top-right social-sub w-auto d-flex list-unstyled p-0 m-0">
                                <li><a href="https://www.facebook.com/gncmh" target="_blank" aria-label="Go to Guru Nanak College's Facebook Page" style="color: #333;"><i class="fa-brands fa-facebook-f"></i></a></li>
                                <li><a href="https://www.linkedin.com/company/gncdehradun/" target="_blank" aria-label="Go to Guru Nanak College's Linkedin Page" style="color: #333;"><i class="fa-brands fa-linkedin-in"></i></a></li>
                                <li><a href="https://www.instagram.com/gncdehradun/" target="_blank" aria-label="Go to Guru Nanak College's Instagram Page" style="color: #333;"><i class="fa-brands fa-instagram"></i></a></li>
                            ...
                            <!-- <ul class="header__top-right w-auto d-flex list-unstyled p-0 m-0">
                                <li class="head-search">
                                    <a href="javascript:void(0);" id="search-page-mob" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" aria-label="Search Guru Nanak College Website"
                        ...
                        <div class="lower-header">
                            <ul class="navbar-nav me-auto step-first-menu">
                                <!-- <li class="nav-item">
                                    <a href="https://gnc.edu.in/">Home</a>
                                <li> -->
                                <li class="nav-item dd-menu-lg">
                                    ...
                                    <div class="step-second-menu st-about">
                                        <div class="row g-0 h-100">
                                            <div class="col-xl-4">
                                                <h4 class="text-primary">About Guru Nanak College</h4>
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li>
                                                        <a href="about-us.php">The Guru Nanak College</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <!-- <li>
                                                        <a href="./institutional-social-responsibility.php">Institutional Social Responsibilities</a>
                                                    </li> -->
                                                </ul>
                                            </div>
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-md-4 about-graphic d-none d-lg-block lazybg"
                                                ...
                                                <div class="drop-down-graphic position-relative h-100">
                                                    <h3>GNC College <span>Best Educational</span> Institution
                                                    </h3>
                                                    <div class="dd-graphic-cont position-absolute bottom-0">
                                                        <div class="row g-0">
                                                            <div class="col-6 p-2 py-3 d-flex">
                                                                <div class="dd--title align-self-center mx-auto text-white">
                                                                    <span>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <a href="Paramedical-College-in-Dehradun-Uttarakhand.php">
                                                                            <h4 class="text-primary">Paramedical Programs</h4>
                                                                        </a>
                                                                        <ul class="list-unstyled p-0 m-0">
                                                                            <li><a href="Best-BMRIT-bachelor-in-medical-radio-imagingtechnology-college-in-dehradun.php">Bachelor
                                                                                    of Medical Radio Diagnosis And
                                                                                    Imaging Technology</a></li>
                                                                            <li><a href="Best-bmlt-college-in-dehradun.php">Bachelor
                                                                                    of Medical Laboratory Technology</a>
                                                                            </li>
                                                                            <li><a href="Best-BPT-college-in-Dehradun-Uttarakhand.php">Bachelor
                                                                                    of Physiotherapy</a></li>
                                                                            <li><a href="Best-bsc-optometry-College-in-dehradun.php">Bachelor of
                                                                                    Optometry</a></li>
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <ul class="list-unstyled p-0 m-0">
                                <li><a href="Best-B-Sc-Nursing-Colleges-in-dehradun.php">B.Sc.
                                        Nursing</a></li>
                                <li><a href="best-gnm-college-in-dehradun.php">General Nursing and
                                        Midwifery</a></li>
                ...
                <div class="col-xl-4">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="Pharmacy-College-in-Dehradun-Uttarakhand.php">
                                <h4>Pharmacy Programs</h4>
                            </a>
                            <ul class="list-unstyled p-0 m-0">
                                <li><a href="best-College-for-B-Pharmacy-in-Dehradun-Uttarakhand.php">Bachelor of
                                        Pharmacy</a></li>
                                <li><a href="B-Pharm-Lateral-Entry-Colleges-in-Dehradun-Uttarakhand.php">Lateral Entry in
                                        B. Pharma</a></li>
                                <li><a href="Best-College-for-D-Pharm-in-Dehradun-Uttarakhand.php">Diploma in
                                        Pharmacy</a></li>
                            </ul>
                        </div>
                        <div class="col-12 mt-2">
                            <a href="Top-Health-Science-College-in-Dehradun-Uttarakhand.php">
                                <h4>Health Science</h4>
                            </a>
                            <ul class="list-unstyled p-0 m-0">
                                <li><a href="master-of-public-health.php">Master
                                        of Public Health</a></li>
                                <li><a
                                        href="master-of-hospital-administration.php">Master
                                        of Hospital Administration</a></li>
                            </ul>
                        </div>
                        <div class="col-12 mt-2">
                            <a href="Best-Management-College-in-Dehradun.php">
                        ...
                        <div class="col-12 mt-2">
                            <a href="Best-Bsc-Agriculture-College-in-Dehradun-Uttarakhand.php">
                                <h4>Agriculture Science</h4>
                            </a>
                            <ul class="list-unstyled p-0 m-0">
                                <li><a href="agriculture-science.php">B.Sc.
                                        Agriculture</a></li>
                                <li><a href="Best-Bsc-Forestry-colleges-in-Dehradun.php">B.Sc.
                                        Forestry</a></li>
                                <li><a href="Best-Msc-Agronomy-Colleges-in-Dehradun.php">M.Sc.
                                        Agronomy</a></li>
                                <li><a href="msc-horticulture.php">M.Sc.
                                        Horticulture</a></li>
                            </ul>
                        </div>
                ...
                <div class="col-xl-4">
                    <div class="row">
                        <div class="col-12">
                            <a href="Top-College-for-Life-and-Allied-Sciences-in-Dehradun-Uttarakhand.php">
                                <h4>Life & Allied Science</h4>
                            </a>
                            <ul class="list-unstyled p-0 m-0">
                                <li><a href="Bsc-microbiology-Colleges-in-Dehradun-Uttarakhand.php">B.Sc.
                                        Microbiology</a></li>
                                <li><a href="bsc-biotechnology.php">B.Sc.
                                        Biotechnology</a></li>
                                <li><a href="bsc-food-technology.php">B.Sc.
                                        Food Technology</a></li>
                                <li><a href="Bsc-pcm-Colleges-in-Dehradun-Uttarakhand.php">B.SC. PCM</a>
                                </li>
                                <li><a href="bsc-cbz.php">B.SC. CBZ</a>
                                </li>
                                <li><a href="Bsc-geology-College-in-Dehradun-Uttarakhand.php">B.Sc.
                                        Geology</a></li>
                                <li><a href="msc-microbiology-Colleges-in-Dehradun.php">M.Sc.
                                        Microbiology</a></li>
                                <li><a href="msc-food-tech-Colleges-in-Dehradun-Uttarakhand.php">M.Sc.
                                        Food Technology</a></li>
                                <li><a href="msc-chemistry-Colleges-in-Dehradun-Uttarakhand.php">M.Sc.
                                        Chemistry</a></li>
                                <li><a href="msc-physics-College-in-Dehradun-Uttarakhand.php">M.Sc.
                                        Physics</a></li>
                                <li><a href="msc-botany-Colleges-in-Uttarakhand.php">M.Sc.
                                        Botany</a></li>
                                <li><a href="msc-zoology-Colleges-in-Dehradun-Uttarakhand.php">M.Sc.
                                        Zoology</a></li>
                            </ul>
                        </div>
                        <div class="col-12 mt-2">
                            <a href="Best-Hotel-Management-College-in-Dehradun.php">
                                <h4>Hotel Management</h4>
                            </a>
                            <ul class="list-unstyled p-0 m-0">
                                <li><a href="Best-DHM-Colleges-in-Dehradun.php">Diploma
                                        in Hotel Management</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-lg-12 pg-bg program-graphic d-none d-lg-block lazybg"
            style="background: url('upload/infra/lazy-program-dd-image.webp'); margin: -20px -20px -20px 20px; background-size: cover;"
            data-src="upload/infra/lazy-program-dd-image.webp">
            <div class="program-drop-down-graphic position-relative h-100">
                <h3 class="text-dark">College with <span>Best Placements</span></h3>
                <div class="placement--ddNumbers progNos mt-3">
                    <div class="row g-2">
                        ...
                        <div class="col-4 col-xl-12">
                            <div class="card p-2">
                                <span>
                                    <h4 id="high-pk"><span class="d-none"></span>1.01
                                        <sub>CR
                                        </sub>
                                    </h4>
        ...
        <li class="nav-item dd-menu-lg">
            ...
            <div class="step-second-menu st-academics">
                <div class="row g-0 h-100">
                    <div class="col-lg-5">
                        <h4 class="text-primary">Academics</h4>
                        <ul class="list-unstyled p-0 m-0">
                            <li>
                                <a href="academic-overview.php">Academic Overview</a>
                            </li>
                            <li>
                                <a href="college-and-department.php">Colleges &amp;
                                    Departments</a>
                            </li>
                            <!-- <li>
                                                            <a href="#">Curriculum Innovations</a>
                                                        </li>
                                                        <li>
                                                            <a href="#">Examination</a>
                                                        </li>
                                                        <li>
                                                            <a href="#">Student Mentoring</a>
                                                        </li> -->
                            <li>
                                <a href="library.php">Libraries</a>
                            </li>
                            <li>
                                <a href="lab.php">Lab Infrastructure</a>
                            </li>
                            <li>
                                <a href="sport.php">Sports &amp; Adventure</a>
                            </li>
                            <li>
            ...
            <div class="step-second-menu st-admissions">
                <div class="row">
                    <div class="col-xl-4 col-lg-6">
                        <h4 class="text-primary">Job Oriented Programs</h4>
                        <div class="row">
                            <div class="col-md-12">

                                <ul class="list-unstyled p-0 m-0">
                                    <li>
                                        <a href="after-12.php">After 12th</a>
                                    </li>
                                    <!-- <li>
                                                                        <a href="https://www.gnc.edu.in/industry-sponsored">Industry Sponsored Program</a>
                                                                    </li> -->
                                    <li>
                                        <a href="after-graduation.php">After
                                            Graduation</a>
                                    </li>
                                    <li>
                                        <a href="admissions.php">Admission
                                            Overview</a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-8 col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <ul class="list-unstyled p-0 m-0">
                                    <li>
                                        <a href="iai.php">Industry-Academia
                                            Interface</a>
                                    </li>
                                    <li>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="campusArea">
                                                        <div class="row g-0">
                                                            <div class="col-6">
                                                                <a href="https://gnc.edu.in/">
                                                                    <img src="includes/assets/images/header-footer/cuchd-icon.png"
                                                                        alt="">
                                                                    <span>Guru Nanak <br>Campus</span>
                                                                </a>
                                                            </div>
                                                            <div class="col-6">
                                                                <a href="http://www.culko.in/" target="_blank">
                                                                    <img src="includes/assets/images/header-footer/culko-icon.png"
                                                                        alt="">
                                                                    <span>Lucknow <br>Campus</span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="d-none d-lg-block" style="margin: 65px -20px 0 -20px;">
                    <div class="redbox-applynow position-relative seagreen-overlay-faded lazybg">
                        <div class="position-relative">
                            <h3 class="text-white">Unlock your Career Goals</h3>
                            <div class="row g-0">
        ...
        <li class="nav-item">
            <a href="unfold-cbc.php">Unfold CBC</a>
        <li>
        <li class="nav-item dd-menu-lg">
            ...
            <div class="step-second-menu st-campus">
                <div class="d-none d-lg-block" style="margin: -20px -20px 15px -20px;">
                    <div class="redbox-applynow position-relative seagreen-overlay-faded lazybg">
                        <div class="position-relative">
                            <h3 class="text-white">A Home away from Home</h3>
                            <div class="row g-0">
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="list-unstyled p-0 m-0">
                                    <li>
                                        <a href="campus-life.php">Campus Life Overview</a>
                                    </li>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="list-unstyled p-0 m-0">
                                    <li>
                                        <a href="cultural.php">Cultural Activities</a>
                                    </li>
                                    <li>
            ...
            <div class="step-second-menu st-placements">
                <div class="row g-0 h-100">
                    <div class="col-lg-6 d-none d-lg-block lazybg"
                        ...
                        <div class="drop-down-graphic position-relative h-100">
                            <h3>Most sought after<span>Destination</span>of blue-chip companies
                            </h3>
                                ...
                                <div class="row g-0">
                                    <div class="col-6 p-2 py-3 d-flex">
                                        <div class="dd--title align-self-center mx-auto">
                                            <span>
                                                <img src="upload/icon/1.png" alt="company-1" loading="lazy" class="img-fluid">
                                            </span>
                                    ...
                                    <div class="col-6 p-2 py-3 d-flex">
                                        <div class="dd--title align-self-center mx-auto">
                                            <span>
                                                <img src="upload/icon/2.png" alt="company-2" loading="lazy" class="img-fluid">
                                            </span>
                                    ...
                                    <div class="col-6 p-2 py-3 d-flex">
                                        <div class="dd--title align-self-center mx-auto">
                                            <span>
                                                <img src="upload/icon/3.png" alt="company-3" loading="lazy" class="img-fluid">
                                            </span>
                                    ...
                                    <div class="col-6 p-2 py-3 d-flex">
                                        <div class="dd--title align-self-center mx-auto">
                                            <span>
                                                <img src="upload/icon/4.png" alt="company-4" loading="lazy" class="img-fluid">
                    ...
                    <div class="col-lg-6">
                        <h4 class="text-primary">Placements</h4>
                        <ul class="list-unstyled p-0 m-0">
                            <li>
                                <a href="placement-overview.php">Placement
                                    Overview</a>
                            </li>
                            <li>
                                <a href="corporate-partners.php">Corporate
                                    Partners</a>
                            </li>
                            <li>
                                <a href="industrial-visit.php">Industrial Visit</a>
                            </li>
                        </ul>
                    </div>
                </div>
