...
<script>
document.getElementById('gnc-chat-btn').addEventListener('click', function () {
    if (typeof eeChatBot !== 'undefined' && eeChatBot.toggleChatWindow) {
        eeChatBot.toggleChatWindow();
    } else {
        ...
        if (icon) {
            ...
            window.open('https://wa.me/917300900900?text=Hi GNC', '_blank');
        }
    }
});
</script>
