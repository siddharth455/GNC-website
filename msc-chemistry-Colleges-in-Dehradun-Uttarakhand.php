    ...
    <div class="gnc-bento-container">
        ...
        <div class="right-stack">
            ...
            <div class="gnc-bento-item bg-light-grey" style="flex: 1;" data-aos="fade-right" data-aos-duration="800">
                ...
                <p>Admission to the M.Sc. Chemistry program at Guru Nanak College, Dehradun, is generally merit-based. Candidates are evaluated on their academic performance in their undergraduate degree, preferably in chemistry or related disciplines.</p>
                <p>The college may also conduct counseling sessions to assess candidates’ understanding of chemistry and their aptitude for advanced studies in the subject.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC M.Sc. Chemistry Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Chemistry (M.Sc. Chemistry)</h3>
                <p>Graduates of the M.Sc. Chemistry program can explore diverse career opportunities across industries and research sectors. They can work in pharmaceuticals, chemical manufacturing, environmental testing, materials science, and quality control laboratories. Opportunities also exist in government organizations, research institutes, and regulatory agencies.</p>
                
                <p>Graduates may pursue roles such as analytical chemists, research scientists, laboratory managers, or chemical analysts. Entrepreneurial paths include establishing testing labs, chemical consultancies, or product-based ventures. Further academic pursuits, such as a Ph.D. in Chemistry or related fields, can lead to advanced research roles and careers in teaching and academia.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">M.Sc. Chemistry Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Industrial Chemistry:</b> Roles in pharmaceuticals, chemical manufacturing, and materials science.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Quality & Testing:</b> Working in environmental testing and quality control laboratories.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Research Roles:</b> Careers as analytical chemists, research scientists, and chemical analysts.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Public Sector:</b> Opportunities in government organizations, research institutes, and regulatory agencies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Entrepreneurship:</b> Establishing testing labs, chemical consultancies, or product-based ventures.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Higher Academia:</b> Pursuing a Ph.D. for advanced research and university-level teaching careers.</div>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="why-join-content">
                    ...
                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive and up-to-date curriculum that covers all essential aspects of Chemistry.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Access to advanced laboratories and facilities for hands-on training in chemical analysis and research.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced faculty with expertise in various domains of chemistry.</p>
                            </div>
                        </li>
