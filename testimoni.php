    <body>
        ...
        <div class="container testimonial-section">
            ...
            <hr class="mt-1" style="width: 300px; color:#DA6B2A;margin:10px auto;height:3px">
            <p class="sub-title">Our Reviews Speak for Us</p>
                        ...
                        <div class="col-md-6">
                            <div class="testimonial-card">
                                <div class="testimonial-content">
                                    ...
                                    <div class="user-info">
                                        <img src="upload/infra/ansar.webp" alt="Md. Ansar Alam - Guru Nanak College Student" loading="lazy">
                                        <h5>Md. Ansar Alam</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 d-md-block d-none">
                            <div class="testimonial-card">
                                <div class="testimonial-content">
                                    ...
                                    <div class="user-info">
                                        <img src="upload/infra/Testimonials images-03.webp" alt="Kritika Raj - Guru Nanak College Student" loading="lazy">
                                        <h5>Kritika Raj</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <div class="testimonial-content">
                                        ...
                                        <div class="user-info">
                                            <img src="upload/infra/Testimonials images-05.webp" alt="Nikita Rai - Guru Nanak College Student" loading="lazy">
                                            <h5>Nikita Rai</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 d-md-block d-none">
                                ...
                                <div class="testimonial-content">
                                        ...
                                        <div class="user-info">
                                            <img src="upload/infra/Testimonials images-02.webp" alt="Rishikesh Kumar - Guru Nanak College Student" loading="lazy">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <div class="testimonial-content">
                                        ...
                                        <div class="user-info">
                                            <img src="upload/infra/Testimonials images-09.webp" alt="Amit Verma - Guru Nanak College Student" loading="lazy">
                                            <h5>Amit Verma</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 d-md-block d-none">
                                ...
                                <div class="testimonial-content">
                                        ...
                                        <div class="user-info">
                                            <img src="upload/infra/Testimonials images-01.webp" alt="Aditya Anand - Guru Nanak College Student" loading="lazy">
                                            <h5>Aditya Anand</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="testimonial-card">
                                    <div class="testimonial-content">
                                        ...
                                        <div class="user-info">
                                            <img src="upload/infra/Testimonials images-07.webp" alt="Rudraksh - Guru Nanak College Student" loading="lazy">
                                            <h5>Rudraksh</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 d-md-block d-none">
                                <div class="testimonial-card">
                                    <div class="testimonial-content">
                                        ...
                                        <div class="user-info">
                                            <img src="upload/infra/Testimonials images-08.webp" alt="Seema Bhujel - Guru Nanak College Student" loading="lazy">
                                            <h5>Seema Bhujel</h5>
                                        </div>
                                    </div>
                                </div>
