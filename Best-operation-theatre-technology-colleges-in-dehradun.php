...
<head>
    ...
    <title> Guru Nanak College | Best Bachelor of Operation Theatre Technology college in Dehradun,Uttarakhand.</title>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>
                        Graduates of the Bachelor of Operation Theatre Technology (BOTT) have a diverse range of career opportunities in the healthcare sector. As Operation Theatre Technologists, they are pivotal in assisting surgeons and anesthesiologists, managing surgical equipment, and maintaining sterile conditions in operation theatres. Their expertise is also crucial in roles such as Surgical Equipment Technicians, where they handle the maintenance and operation of sophisticated surgical tools.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/3UhI5XswpMw?autoplay=1&mute=1&playlist=3UhI5XswpMw&loop=1"
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/ott.webp" alt="operation theater programme" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Operation Theatre Technology (BOTT)</h2>
                            </div>
