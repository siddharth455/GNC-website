...
<head>
    ...
    <meta property="og:title" content="Best BMLT College in Dehradun | Lab Technology at GNC"/>
...
@media (max-width: 768px) {
    .career-glass-grid { grid-template-columns: 1fr; }
        ...
        .why-join-blue {
            background: linear-gradient(80deg, rgb(11, 87, 138) 30%, rgba(30, 34, 82, .1)), url('upload/programs/BMLT.webp') !important;
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "@id": "https://gnc.edu.in/best-bmlt-college-in-dehradun#bmlt-service",
  "serviceType": "Bachelor of Medical Laboratory Technology (BMLT)",
  "name": "BMLT Course in Dehradun",
  "url": "https://gnc.edu.in/best-bmlt-college-in-dehradun",
  "provider": {
...
<script type="application/ld+json">
{
  ...
  "description": "3.5-year undergraduate paramedical degree program with clinical training in pathology, microbiology, clinical biochemistry, and haematology at Guru Nanak College, Dehradun.",
  "provider": {
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/medical-lab-head.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Medical Laboratory Technology</small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                                <a href="upload/pdf/BMLT.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 animate__animated animate__fadeIn">
                        ...
                        <h1 class="display-6 fw-300 my-1">Guru Nanak College - Best BMLT College in Dehradun, Uttarakhand <span style="color:var(--accent)">Uttarakhand</span></h1>
                        <p class="lead text-muted">The Bachelor of Medical Laboratory Technology (BMLT) is a comprehensive three-year undergraduate program designed to provide students with the essential skills and knowledge for a successful career in laboratory medicine. This program covers core subjects like human anatomy, physiology, biochemistry, microbiology, pathology, and hematology, all of which are crucial for
                        understanding human health and diseases.</p>
                       <p class="lead text-muted">If you are aspiring to pursue this program, enrolling in the best BMLT college in Dehradun or the best
                      ...
                      <p class="lead text-muted">Choosing the best BMLT college in Dehradun ensures you get a high-quality education, while best
                    ...
                    <div class="col-lg-5 text-end animate__animated animate__fadeInRight">
                        <div class="premium-card text-start shadow-sm" style="border-left: 5px solid var(--accent)">
                            ...
                            “ The BMLT program is designed to build strong foundations in laboratory sciences while emphasizing accuracy, discipline, and critical thinking. With hands-on training in pathology, microbiology, hematology, and biochemistry, students gain the practical skills required to support diagnosis and treatment in modern healthcare settings.”
                           </p>
        ...
        <div class="container">
            <div class="flex-container">
                ...
                <div class="col-data">
                    ...
                    <a href="upload/pdf/fee/BMLT.jpeg" target="_blank" id="printButton1" target="_blank" class="btn-download">Download Fee Structure</a>
                ...
                <div class="row g-0 shadow-lg rounded-4 overflow-hidden border scroll-reveal">
                    ...
                    <div class="col-lg-7 bg-white p-4 p-md-5">
                        ...
                        <div class="practice-list-container">
                            <?php
                            $practices = [
                                "Promoting practical approach and clinical reasoning.",
                                "Evidence based practice.",
                                "Learning with problem solving based upon life situations.",
                                "Constructive approach (theory & practice).",
                                "Use of advance learning methods.",
                                "Peer teaching & Topic sequencing.",
                        ...
                        <div class="assessment-quote mt-4 p-3 rounded-3 scroll-item">
                            <p class="mb-0 x-small text-muted">
                                ...
                                <strong>Assessment Methods:</strong> mini-CEX, Case-based discussion, DOPs, and Multi-source feedback.
                            </p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="empower-card mb-3 p-3 scroll-item shadow-sm">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-0 small">Direct Clinical Exposure</h6>
                                        <p class="x-small text-muted mb-0">Daily OPD rotations at affiliated multispeciality hospitals.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="empower-card mb-3 p-3 scroll-item shadow-sm">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="x-small text-muted mb-0">Advanced Diagnostic Techniques, Molecular Biology, and Lab Management workshops.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="empower-card mb-4 p-3 scroll-item shadow-sm">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="x-small text-muted mb-0">Organizing free blood testing and health awareness camps.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="empower-card mb-4 p-3 scroll-item shadow-sm">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="x-small text-muted mb-0">Mentorship for undergraduate research projects and patent filing.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-2 scroll-item">
                                <div class="col-6">
                                    <div class="p-2 border rounded-3 bg-white text-center">
                                        <span class="d-block fw-bold text-theme h5 mb-0">15+</span>
                                        <span class="x-small text-uppercase fw-bold text-muted">Core Labs</span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-2 border rounded-3 bg-white text-center">
                                        <span class="d-block fw-bold text-theme h5 mb-0">100%</span>
                                        <span class="x-small text-uppercase fw-bold text-muted">Hands-on</span>
                                    </div>
                                </div>
                            </div>
                        </div>
 ...
 <section class="gnc-bmrit-wrapper">
    <div class="container-fluid px-lg-5">
        ...
        <div class="text-center mb-5 bmr-reveal">
            <h2 class="fw-extrabold display-5 mb-2" style="color: #0f9af1;">Career Prospects After BMLT</h2>
            <p class="fw-bold text-uppercase tracking-wider" style="color: #fb7b1c;">Shape the Future of Diagnostic Medicine</p>
        </div>
            ...
            <div class="col-lg-6 bmr-reveal">
                <div class="career-glass-grid">
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            <h6>Medical Laboratory Technologist</h6>
                            <span>Working in hospitals, clinics, and research labs.</span>
                        </div>
                    </div>
                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-microscope"></i></div>
                        <div class="node-text">
                            <h6>Cytotechnologist</h6>
                            <span>Studying cells to detect cancer and other diseases.</span>
                        </div>
                    </div>
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            <h6>Phlebotomist</h6>
                            <span>Collecting blood samples for medical testing.</span>
                        </div>
                    </div>
                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-dna"></i></div>
                        <div class="node-text">
                            <h6>Biomedical Scientist</h6>
                            <span>Conducting research to improve healthcare.</span>
                        </div>
                    </div>
                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-clipboard-check"></i></div>
                        <div class="node-text">
                            <h6>Quality Control Manager</h6>
                            <span>Ensuring laboratory results are accurate and reliable.</span>
                        </div>
                    </div>
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            ...
                            <span>Educating the next generation of technologists.</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="gnc-benefits-card bmr-item">
                    ...
                    <div class="benefits-content p-4">
                        <div class="benefit-row">
                            ...
                            <p><strong>Advanced Simulation Labs:</strong> Train on modern imaging software before hitting the hospital.</p>
                        </div>
                        <div class="benefit-row">
                            <i class="fa-solid fa-circle-check"></i>
                            <p><strong>Clinical Rotations:</strong> Guaranteed internships in Top-tier multispeciality hospitals.</p>
                        </div>
                        <div class="benefit-row">
                            <i class="fa-solid fa-circle-check"></i>
                            <p><strong>Expert Faculty:</strong> Learn from industry veterans and PhD radiology scholars.</p>
                        </div>
                    </div>
                </div>
            </div>
