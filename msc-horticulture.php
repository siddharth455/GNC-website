...
<body>
   ...
   <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/agri-5.webp'); background-repeat: no-repeat; background-size: cover;">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                ...
                                <a href="upload/pdf/MSc-Horticulture.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best M.Sc in Horticulture College in Dehradun, Uttarakhand</h2>
                <p>The Master of Science in Horticulture (M.Sc. Horticulture) at Guru Nanak College, Dehradun,
                            is a dynamic postgraduate program designed for individuals passionate about the cultivation of plants,
                            garden and landscape design, and the study of plant species. This two-year course at the Guru Nanak
                            College, the Best M.Sc Horticulture College in Dehradun, Uttarakhand delves deep into the science and
                            art of growing fruits, vegetables, flowers, and ornamental plants, combining theoretical knowledge with
                            practical application.</p>
                        <p>This program equips students with advanced knowledge in various aspects of horticulture including
                            plant biology, propagation, breeding, sustainable and urban horticulture, post-harvest technology, and
    ...
    <div class="gnc-bento-container">
        ...
        <div class="right-stack">
            ...
            <div class="gnc-bento-item bg-light-grey" style="flex: 1;" data-aos="fade-right" data-aos-duration="800">
                ...
                <p>Admission to the M.Sc. Horticulture program at Guru Nanak College, Dehradun, is based on academic merit. Prospective students are evaluated on their academic achievements in their undergraduate studies.</p>
                <p>The college may also conduct counseling sessions to gauge applicants' interest in horticulture, their innovative thinking, and their potential for contributing to the field.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="M.Sc. Horticulture Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Horticulture (M.Sc. Horticulture)</h3>
                <p>
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">M.Sc. Horticulture Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Research & Development:</b> Enhancing plant varieties and developing eco-friendly gardening solutions.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Landscape & Design:</b> Consultancy for garden planning and maintenance in private and public sectors.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Government Sector:</b> Roles in urban planning, park management, and environmental conservation.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Academic Careers:</b> Opportunities in teaching and high-level research at universities and institutes.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Entrepreneurship:</b> Starting independent nurseries, landscape firms, or consultancy services.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Urban Horticulture:</b> Advancing modern, sustainable gardening techniques for urban environments.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nanak College For M.Sc Horticulture in Dehradun?</h3>
                    <p>The School of Agriculture Science at Guru Nanak College offers a comprehensive M.Sc. Horticulture program that combines academic excellence with practical experience. Our commitment is to groom future leaders and professionals in horticulture and sustainable resource management.</p>

                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            <div class="ms-3">
                                <p class="mb-0"><b>The program is distinguished by its:</b></p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div class="ms-3">
                                <p class="mb-0">State-of-the-art facilities, including modern greenhouses, botanical gardens, and well-equipped laboratories.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A constantly evolving curriculum that incorporates the latest trends, technologies, and sustainable practices in horticulture.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced faculty comprising esteemed academicians and industry professionals.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Strong focus on research and practical application, with opportunities for students to engage in innovative projects and field experiences.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Partnerships with horticultural businesses and research organizations, providing students with practical insights and networking opportunities.</p>
                            </div>
                        </li>
                    </ul>
                    
                    <p class="text-white">Our commitment is to foster a new generation of horticulture experts and leaders who can significantly contribute to the field, enhancing both the aesthetics and functionality of cultivated spaces. Students are supported in their academic journey and career aspirations, including guidance for further studies and assistance with job placements in the vibrant horticulture industry.</p>
