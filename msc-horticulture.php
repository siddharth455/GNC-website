                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/agri-image.webp" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Master of Science in Horticulture</h2>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <li>Minimum qualification required is 4 year graduation degree in Agriculture/Horticulture/ Forestry.</li>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
            <li>Admission to the M.Sc. Horticulture program at Guru Nanak College, Dehradun, is based on academic merit. Prospective students are evaluated on their academic achievements in their undergraduate studies.</li>
                <li>The college may also conduct counseling sessions to gauge applicants' interest in horticulture, their innovative thinking, and their potential for contributing to the field.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        <div class="page-heading">
                            <h3>Why Join Guru Nank College For M.Sc Horticulture in Dehradun?</h3>
                        </div>
                        <p>The School of Agriculture Science at Guru Nanak College For B.Sc Forestry in Dehradun offers
                            a comprehensive B.Sc. Forestry program that combines academic excellence with practical experience.
                            Our commitment is to groom future leaders and professionals in forest conservation and sustainable
