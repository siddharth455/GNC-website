...
<head>
    ...
    <title>Best B Pharma College in Dehradun | B.Pharm Admission 2026 – Guru Nanak College</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Join Guru Nanak College, one of the best B Pharma colleges in Dehradun. PCI-approved B.Pharm program with modern labs, expert faculty, scholarships, and strong placement support.">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "A 4-year undergraduate degree in pharmaceutical sciences, focusing on drug development and healthcare.",
      "provider": {
...
<style>
        ...
        /* --- Marquee Section --- */
        .marquee-section {
            background: #FB7B1C; /* Using hex directly or mapping to --gnc-orange */
            padding: 16px 0;
            overflow: hidden;
            white-space: nowrap;
        }
...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <h2 class="fw-light" data-aos="fade-right" data-aos-duration="500">School of <br><b>Pharmaceutical
                            Sciences</b></h2>
                     <p class="mt-4 mb-0 fw-bold" data-aos="fade-right" data-aos-duration="600">(B.Pharm)</p>
                    <h1 class="gnc-mb-hero-h1" data-aos="fade-right" data-aos-duration="700">Bachelor of <br>Pharmacy<br> at Guru Nanak College</h1>
    ...
    <div class="marquee-section">
      <div class="marquee-track" id="marqueeTrack">
        <span>B.Pharm 2026 Admissions Open</span><span class="dot">◆</span>
        ...
        <span>4-Year Undergraduate Program</span><span class="dot">◆</span>
        ...
        <div class="about-grid">
            <div class="about-left reveal-left">
                <div class="about-image-wrap">
                    <div style="width:100%;height:100%; background: url('images/Class.webp') center/cover no-repeat; display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;">
                    </div>
             ...
             <div class="about-right">
                ...
                <h2 class="section-title-about reveal">Guru Nanak College - Best <span class="accent">B.Pharm</span> College in Dehradun, <span class="">Uttarakhand</span></h2>
                <p class="reveal d1">The Bachelor of Pharmacy (B.Pharm) program at Guru Nanak College is a comprehensive four-year undergraduate course designed to provide students with a deep understanding of pharmaceutical sciences. Our program is meticulously structured to cover all aspects of drug development, from discovery and formulation to clinical testing and regulatory approval.</p>
                <p class="reveal d2">At Guru Nanak College, we emphasize a blend of theoretical knowledge and practical expertise. Students have access to state-of-the-art laboratories and are guided by experienced faculty members who are experts in their respective fields. This approach ensures that our graduates are well-equipped to meet the challenges of the dynamic pharmaceutical industry and contribute significantly to global healthcare.</p>
                <p class="reveal d3">Our curriculum is continuously updated to stay in sync with the latest industry trends and technological advancements. Beyond academics, we provide extensive placement support and career counseling, helping students secure positions in top pharmaceutical companies, research organizations, and healthcare institutions worldwide. By choosing Guru Nanak College, students embark on a journey of excellence, innovation, and professional growth in the field of pharmacy.</p>
                <div class="about-tags reveal d4">
                    <div class="about-tag">8 Semesters</div>
                    <div class="about-tag">PCI Approved</div>
                    <div class="about-tag">Industry Aligned</div>
                    <div class="about-tag">Clinical Focus</div>
                    <div class="about-tag">Research Driven</div>
    ...
    <section class="curriculum-gallery" id="subjects">
      <div class="curriculum-header">
        ...
        <div class="curriculum-summary">
          <p>The B.Pharm curriculum at Guru Nanak College is strictly aligned with PCI standards, ensuring students gain a competitive edge in the pharmaceutical industry. The program focuses on advanced pharmaceutical sciences, covering critical subjects that bridge the gap between academic training and professional application.</p>
        </div>
      </div>
      ...
      <div class="curriculum-viewport" id="curriculumScroll">
        <div class="curriculum-list">
          <div class="curriculum-item">
            ...
            <div class="curriculum-title">Pharmaceutical Chemistry</div>
            <div class="curriculum-info">Focus on drug design, chemical synthesis, and the study of molecular structures to develop effective medications.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">02</div>
            <div class="curriculum-symbol">💊</div>
            <div class="curriculum-title">Pharmacology</div>
            <div class="curriculum-info">Studying the effects of drugs on biological systems and how they interact with the body to treat diseases.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">03</div>
            <div class="curriculum-symbol">🏭</div>
            <div class="curriculum-title">Pharmaceutics</div>
            <div class="curriculum-info">The science of dosage form design, transforming new chemical entities into safe and effective medications.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">04</div>
            <div class="curriculum-symbol">🌿</div>
            <div class="curriculum-title">Pharmacognosy</div>
            <div class="curriculum-info">Study of medicinal drugs derived from plants, animals, and other natural sources for therapeutic use.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">05</div>
            <div class="curriculum-symbol">🧬</div>
            <div class="curriculum-title">Biochemistry</div>
            <div class="curriculum-info">Exploring the chemical processes within and relating to living organisms, essential for understanding drug action.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">06</div>
            <div class="curriculum-symbol">📊</div>
            <div class="curriculum-title">Pharmaceutical Analysis</div>
            <div class="curriculum-info">Developing techniques to identify and quantify components in pharmaceutical products for quality control.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">07</div>
            <div class="curriculum-symbol">🦴</div>
            <div class="curriculum-title">Human Anatomy & Physiology</div>
            <div class="curriculum-info">Study of the structure and function of the human body, essential for understanding drug effects.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">08</div>
            <div class="curriculum-symbol">🏥</div>
            <div class="curriculum-title">Pathophysiology</div>
            <div class="curriculum-info">Understanding the functional changes associated with disease or injury to better target therapies.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">09</div>
            <div class="curriculum-symbol">🧫</div>
            <div class="curriculum-title">Pharmaceutical Microbiology</div>
            <div class="curriculum-info">Study of microorganisms associated with the manufacture of pharmaceuticals and disease control.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">10</div>
            <div class="curriculum-symbol">⚙️</div>
            <div class="curriculum-title">Pharmaceutical Engineering</div>
            <div class="curriculum-info">Applying engineering principles to the design and operation of pharmaceutical manufacturing processes.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">11</div>
            <div class="curriculum-symbol">🧬</div>
            <div class="curriculum-title">Pharmaceutical Biotechnology</div>
            <div class="curriculum-info">Using biological systems or organisms to develop or make pharmaceutical products.</div>
          </div>
          <div class="curriculum-item">
            <div class="curriculum-step">12</div>
            <div class="curriculum-symbol">🏢</div>
            <div class="curriculum-title">Industrial Pharmacy</div>
            <div class="curriculum-info">Focus on large-scale drug production, quality assurance, and regulatory compliance in the industry.</div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
            <div class="gnc-mb-fee-container">
                ...
                <div class="gnc-mb-fee-col">
                    ...
                    <a href="upload/pdf/fee/B.Pharmacy.jpeg" target="_blank" class="gnc-mb-btn-fee-download">
                    ...
                    <div class="tab-content pt-4">
                        <div class="tab-pane fade show active" id="fee-pane" role="tabpanel">
                            <div class="mb-4">
                                ...
                                <p class="gnc-mb-text-p" style="font-size: 1rem; line-height: 1.5;">The students who have passed 10+2 or had given senior secondary examination with Maths/Biology/Agriculture from any recognized board.<br>
                ...
                <aside class="gnc-mb-video-sidebar">
                    <div class="video-promo-card">
                        <a href="javascript:void(0)" class="video-btn-play" onclick="openVideoPopup('7hk7G0SEhZ0')">
                            <div class="video-play-icon">
                                <i class="fas fa-play text-white"></i>
                            </div>
                            Watch Video
                        </a>
                        <a href="javascript:void(0)" class="video-thumb-link" onclick="openVideoPopup('7hk7G0SEhZ0')">
                            <img src="https://img.youtube.com/vi/7hk7G0SEhZ0/maxresdefault.jpg" alt="Video Thumbnail">
                        </a>
                    </div>
 ...
 <!-- Career Opportunities Section -->
    <section class="pharmacy-container" data-aos="fade-up">
        <div class="content-right">
            ...
            <p class="intro-text">
                After completing a Bachelor of Pharmacy (B.Pharm), graduates have diverse career paths available.
                They can work as pharmacists in retail or hospital pharmacies, advising on and dispensing
                medications. Opportunities also exist in the pharmaceutical industry, including roles in drug
                manufacturing, quality control, and marketing. B.Pharm graduates can engage in research and
                development, contributing to the creation of new drugs, or enter the academic field as educators
                and researchers. Regulatory roles in agencies like the FDA are another option, focusing on drug
                compliance and safety. The growing field of clinical research offers positions in drug trials
                and safety analyses.
            </p>
                ...
                <div class="slider-view" id="pharmacySliderView">
                    <div class="slider-track" id="pharmacySliderTrack">
                        <div class="pathway-card">
                            <h5><i class="fas fa-microscope"></i> Drug Inspector</h5>
                            <p>Monitor quality and compliance of medicines within government regulatory frameworks.</p>
                        </div>
                        <div class="pathway-card">
                            <h5><i class="fas fa-flask"></i> Research Scientist</h5>
                            <p>Leading innovations in drug formulation and breakthrough medical discovery.</p>
                        </div>
                        <div class="pathway-card">
                            <h5><i class="fas fa-check-circle"></i> Quality Control</h5>
                            <p>Ensuring every batch meets the highest international purity and efficacy standards.</p>
                        </div>
                        <div class="pathway-card">
                            <h5><i class="fas fa-user-md"></i> Clinical Associate</h5>
                            <p>Managing trials and data safety for life-saving global healthcare innovations.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid-left">
            <div class="img-box"><img src="images/b.pharma-1.webp" alt="Pharmacy Lab"></div>
            <div class="img-box"><img src="upload/programs/b-pharma-3.jpg" alt="Medicine Quality"></div>
            ...
            <div class="why-choose-us-layout">
                <div class="why-choose-us-images">
                    <div class="image-stack">
                        ...
                        <img src="images/bp-9.jpg" alt="GNC Student 2" class="stack-img img-2">
                    </div>
                </div>
                <div class="why-choose-us-content">
                    <h2 class="why-choose-us-title">Why Choose Guru Nanak College for B.Pharm in Dehradun?</h2>
                    <p class="why-choose-us-description">At the School of Pharmacy, part of the esteemed Guru Nanak College, Dehradun, we are dedicated to offering top-tier education in pharmaceutical sciences. Our aim is to develop skilled professionals equipped to meet global healthcare and pharmaceutical challenges. The campus boasts advanced educational facilities for a comprehensive learning experience.</p>
                    <div class="why-choose-us-features-list">
                        <div class="feature-list-item">
                            <div class="feature-tick"><i class="fas fa-check"></i></div>
                            <div class="feature-content">
                                <h4 class="feature-title">Industry Aligned</h4>
                                <p class="feature-text">Our course structure is aligned with current pharmaceutical industry standards, ensuring students gain relevant, employable skills.</p>
                            </div>
                        </div>
                        <div class="feature-list-item">
                            <div class="feature-tick"><i class="fas fa-check"></i></div>
                            <div class="feature-content">
                                ...
                                <p class="feature-text">Students receive practical training in modern labs equipped with advanced instruments for formulation, testing, and research.</p>
                            </div>
                        </div>
                        <div class="feature-list-item">
                            <div class="feature-tick"><i class="fas fa-check"></i></div>
                            <div class="feature-content">
                                ...
                                <p class="feature-text">Learn from highly qualified pharmacy professionals with academic and industry experience.</p>
                            </div>
                        </div>
                        <div class="feature-list-item">
                            <div class="feature-tick"><i class="fas fa-check"></i></div>
                            <div class="feature-content">
                                <h4 class="feature-title">Placement Support</h4>
                                <p class="feature-text">Dedicated placement training, industry collaborations, and career mentoring help students secure roles in top pharmaceutical companies.</p>
                            </div>
                        </div>
                        <div class="feature-list-item">
                            <div class="feature-tick"><i class="fas fa-check"></i></div>
                            <div class="feature-content">
                                ...
                                <p class="feature-text">Students are encouraged to participate in research projects, seminars, and scientific conferences.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- MAIN SECTION END -->
    ...
    <aside class="gnc-faq-sidebar">
        ...
        <p class="gnc-sidebar-text">
            Secure your seat for Bachelor of Pharmacy (B.Pharm) Admission 2026 at Guru Nanak College, Dehradun. Apply now or book a campus visit to begin your professional journey in pharmaceutical sciences.
        </p>
   ...
   <main class="gnc-faq-main">
        ...
        <div class="gnc-faq-list">
            ...
            <details class="gnc-faq-item">
                <summary>Is admission open for B.Pharm 2026?</summary>
                <div class="gnc-faq-answer">
                    Yes, Bachelor of Pharmacy (B.Pharm) admission for the 2026 academic session is currently open. Candidates are encouraged to apply early to secure their preference in this specialized pharmaceutical program.
                </div>
            </details>

            <!-- Q2 -->
            <details class="gnc-faq-item">
                <summary>What is the eligibility for the B.Pharm program?</summary>
                <div class="gnc-faq-answer">
                    Candidates should have completed 10+2 with Physics and Chemistry as compulsory subjects along with Mathematics or Biology, with at least 45% marks (40% for SC/ST candidates) from a recognized board.
                </div>
            </details>

            <!-- Q3 -->
            <details class="gnc-faq-item">
                <summary>Are laboratory practicals and internships included in the B.Pharm curriculum?</summary>
                <div class="gnc-faq-answer">
                    Yes, practical training in our state-of-the-art labs and industrial internships are core parts of our B.Pharm program. Students gain hands-on experience in drug formulation, analysis, and clinical research.
                </div>
            </details>

            <!-- Q4 -->
            <details class="gnc-faq-item">
                <summary>What career roles can I expect after B.Pharm?</summary>
                <div class="gnc-faq-answer">
                    Graduates can pursue roles such as Registered Pharmacist, Drug Inspector, Quality Control Associate, Clinical Research Coordinator, Production Manager in pharmaceutical industries, and Healthcare Consultant.
                </div>
            </details>
        </div>
    </main>
...
<script>
    ...
    const labData = [
        ...
        // { title: "Computer and Fundamental Lab", imageUrl: "images/labs/lab-12.webp" },
        { title: "Pediatric Lab", imageUrl: "images/labs/lab-13.webp" },
        { title: "Nutrition Lab", imageUrl: "images/labs/lab-14.webp" },
        { title: "Fundamental of Nursing Lab", imageUrl: "images/labs/lab-15.webp" }
    ];
