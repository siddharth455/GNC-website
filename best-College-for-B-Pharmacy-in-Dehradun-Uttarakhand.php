...
<head>
    ...
    <meta property="og:description" content="Guru Nanak College, Dehradun's best college for a Bachelor of Pharmacy. With an innovative curriculum, renowned faculty, and state-of-the-art facilities, Guru Nanak College prepares future pharmacists to lead and innovate in the ever-evolving healthcare industry." />
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/infra/pharmacy-banner.jpg'); background-repeat: no-repeat; background-size: cover;">
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best Bachelor of Pharmacy (B.Pharm) College in Dehradun, Uttarakhand</h2>
            ...
            <div class="flex-container">
                ...
                <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/7hk7G0SEhZ0?autoplay=1&mute=1&playlist=7hk7G0SEhZ0&loop=1" title="B.Pharmacy Program Video" allowfullscreen></iframe>
                    </div> 
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                ...
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Pharmacists:</b> Working in retail or hospital pharmacies, advising on and dispensing medications.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Industry Roles:</b> Opportunities in the pharmaceutical industry, including drug manufacturing and quality control.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>R&D:</b> Engaging in research and development, contributing to the creation of new drugs.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Regulatory:</b> Roles in agencies like the FDA, focusing on drug compliance and safety.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Research:</b> Positions in the growing field of drug trials and safety analyses.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Sales & Marketing:</b> Pharmaceutical sales and marketing offering a blend of science and commerce.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Pharmacy (B.Pharm) in Dehradun?</h3>
                    ...
                    <ul class="check-list-white">
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Modern laboratories equipped with the latest technology for practical and research-based learning.s</p>
                            </div>
                        </li>
