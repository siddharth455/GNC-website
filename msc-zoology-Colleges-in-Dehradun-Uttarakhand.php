                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Science in Zoology</small></h3>
                                </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best M.Sc in Zoology College in Dehradun, Uttarakhand</h2>
                <p>The Master of Science in Zoology program at Guru Nanak College, Dehradun is a
                 postgraduate course designed for students passionate about studying animals and their biological
                 processes. This two-year program offers an in-depth understanding of various aspects of animal science,
                 including animal behavior, physiology, taxonomy, ecology, and conservation.</p>
                        <p>The curriculum of the M.Sc. Zoology program provides comprehensive knowledge and skills in both
                           theoretical and practical aspects of zoology. It covers subjects such as animal diversity, endocrinology,genetics, wildlife biology, parasitology, and environmental biology. The course also emphasizes research methodologies, allowing students to conduct detailed studies and experiments in various fields of zoology.
                         </p>
                        <p>Guru Nanak College - Best M.Sc in Zoology College in Dehradun, Uttarakhand provides an excellent
                         platform for aspiring zoologists to advance their academic and professional careers.</p>
    ...
    <div class="gnc-bento-container">
        ...
        <div class="right-stack">
            ...
            <div class="gnc-bento-item bg-light-grey" style="flex: 1;" data-aos="fade-right" data-aos-duration="800">
                ...
                <p>Admission to the M.Sc. Zoology program at Guru Nanak College, Dehradun, typically involves a merit-based selection process. Candidates are evaluated based on their academic performance in their undergraduate degree, preferably in zoology or a related field.</p>
                <p>The college may also conduct counseling sessions to assess the candidates' knowledge in zoology and their aptitude for advanced studies in this field.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC M.Sc. Zoology Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Zoology (M.Sc. Zoology)</h3>
                ...
                <p>Graduates can engage in academic careers as lecturers or researchers, contributing to the advancement of zoological sciences. Further, they can find roles in scientific publishing, wildlife documentary production, and environmental consultancy.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">M.Sc. Zoology Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Wildlife & Ecology:</b> Working as wildlife biologists, conservationists, and ecologists.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Zoo Management:</b> Professional roles as zoo curators and wildlife management experts.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Public & NGO Sector:</b> Opportunities in government and NGOs for environmental protection.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Academia:</b> Pursuing careers as lecturers or researchers in the zoological sciences.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Media & Publishing:</b> Roles in scientific publishing and wildlife documentary production.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Consultancy:</b> Providing expertise in zoology through environmental consultancy firms.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Master of Science in Zoology in Dehradun?</h3>
                    ...
                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            ...
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive curriculum that covers diverse topics in zoology, providing a well-rounded education in the field.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Access to modern laboratories and facilities for practical training and research.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced faculty with expertise in various zoological sub-disciplines.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Opportunities for fieldwork, research projects, and internships in wildlife and conservation settings.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Emphasis on developing critical thinking, research skills, and a scientific approach to the study of animal life.</p>
                            </div>
                        </li>
                    </ul>
