...
including animal behavior, physiology, taxonomy, ecology, and conservation.
</p>
                        <p>The curriculum of the M.Sc. Zoology program provides comprehensive knowledge and skills in both
theoretical and practical aspects of zoology. It covers subjects such as animal diversity, endocrinology,
genetics, wildlife biology, parasitology, and environmental biology. The course also emphasizes research
methodologies, allowing students to conduct detailed studies and experiments in various fields of
zoology.
</p>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Master of Science in Zoology</h2>
                            </div>
