...
<body>
                    ...
                    <div class="row h-100 align-items-center justify-content-between">
                        <div class="col-lg-6 col-xl-5">
                            <div class="banner-content text-lg-start">
                                <h1 class="text-white">Best Private College<br>in Deharadun (India)</h1>
                                <p class="text-white">Ranked Among Top
                                    Accreditation, GNC offers you abundant opportunities for a promising career.</p>
                                <div class="btn-grp">
                                    <a href="#" class="btn btn-light text-dark" target="_blank">Apply Today</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="programForm-sec ms-auto mb-4">
                                <div class="programForm-header">
                                    <h2>Apply Today For</h2>
                                    <h3>Guru Nanak College Programs</h3>
                                </div>
                                <div id="reg-form"></div>
                            </div>
                        </div>
    ...
    <section class="gncPlacement-section container mb-5">
        ...
        <div class="text-center placement-button mt-5 btnsGroup">
            <a href="https://admission.gnc.edu.in/" class="btn blue-gradient" target="_blank">Apply Today</a>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-gnc" role="tabpanel" aria-labelledby="pills-gnc-tab">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                                ...
                                <div class="accordion-body" style="padding: 20px;">
                                    <div class="menu-programs-list__graduates">
                                        <ul class="p-0 list-unstyled list-icon-2" style="font-size: 16px;">
                                            ...
                                            <li><a href="https://gnc.edu.in/Best-BPT-bachelor-of-physiotherapy-college-in-Dehradun" class="program-link">Bachelor of Physiotherapy</a></li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body" style="padding: 20px;">
                                    <div class="menu-programs-list__graduates">
                                        <ul class="p-0 list-unstyled list-icon-2" style="font-size: 16px;">
                                            <li><a href="https://gnc.edu.in/Best-BBA-Colleges-in-DehradunUttarakahnd" class="program-link">Bachelor of Business Administration (BBA)</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTen" aria-expanded="false" aria-controls="flush-collapseTen" style="background-color: #ff7f50; color: #fff; font-size: 16px; font-weight: bold; border-radius: 10px; padding: 10px;">
                                    Vocational Programs
                                </button>
                            </h2>
                            <div id="flush-collapseTen" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body" style="padding: 20px;">
                                    <div class="menu-programs-list__graduates">
                                        <ul class="p-0 list-unstyled list-icon-2" style="font-size: 16px;">
                                            <li><a href="https://www.gnc.edu.in/event-management" class="program-link">Diploma in Event Management</a></li>
                                            <li><a href="https://gnc.edu.in/d-nursung-assisteant" class="program-link">Diploma in Nursing Assistant</a></li>
                                            <li><a href="https://gnc.edu.in/d-fashion-designing" class="program-link">Diploma in Fashion Designing</a></li>
                                            <li><a href="https://gnc.edu.in/d-hospital-administration" class="program-link">Diploma in Hospital Administration</a></li>
                                            <li><a href="https://gnc.edu.in/d-ai-and-ml" class="program-link">Diploma in Artificial Intelligence & Machine Learning</a></li>
                                            <li><a href="https://gnc.edu.in/d-veterinary-hospital-management" class="program-link">Diploma in Veterinary Hospital Management</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseEleven" aria-expanded="false" aria-controls="flush-collapseEleven" style="background-color: #ff7f50; color: #fff; font-size: 16px; font-weight: bold; border-radius: 10px; padding: 10px;">
                                    Arts Programs
                                </button>
                            </h2>
                            <div id="flush-collapseEleven" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body" style="padding: 20px;">
                                    <div class="menu-programs-list__graduates">
                                        <ul class="p-0 list-unstyled list-icon-2" style="font-size: 16px;">
                                            <li><a href="https://gnc.edu.in/fine-arts" class="program-link">Bachelor of Fine Arts (BFA)</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container pt-5 pb-5">
            ...
            <div class="accordion accordion-flush" id="accordionFlushDesktop">
                <div class="row desktop-program">
                    ...
                    <!-- Accordion Body Column (Expandable Content) -->
                    <div class="col-md-8">
                        ...
                        <!-- <div id="flush-collapseTen" class="accordion-collapse collapse" data-bs-parent="#accordionFlushDesktop">
                            <div class="accordion-body" style="padding: 20px;">
                                <div class="menu-programs-list__graduates">
                                    <ul class="p-0 list-unstyled list-icon-2" style="font-size: 16px;">
                                        <li><a href="https://www.gnc.edu.in/event-management" class="program-link">Diploma in Event Management</a></li>
                        ...
                        <div id="flush-collapseEleven" class="accordion-collapse collapse" data-bs-parent="#accordionFlushDesktop">
                            <div class="accordion-body" style="padding: 20px;">
                                <div class="menu-programs-list__graduates">
                                    <ul class="p-0 list-unstyled list-icon-2" style="font-size: 16px;">
                                        <li><a href="https://gnc.edu.in/fine-arts" class="program-link">Bachelor of Fine Arts (BFA)</a></li>
    ...
    <!-- <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Trigger modal again after one minute when it's closed
