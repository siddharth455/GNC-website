...
<head>
 <title>Best College in Dehradun, Uttarakhand | Guru Nanak College</title>
  ...
  <meta property="og:title" content="Best College in Dehradun, Uttarakhand | Guru Nanak College's best educational institute, dedicated to
...
<body>
  ...
  <style>
    ...
    .circle-logo {
      position: absolute;
      width: 80px;
      /* bigger surrounding logos */
      height: 80px;
      border-radius: 50%;
      object-fit: contain;
      /* ensures the logo fits fully */
  ...
  <style>
    ...
    .accordion-menu {
      display: flex;
      flex-direction: row;
      /* Tabs are horizontal rows when vertical */
      background: #f9fafb;
      gap: 8px;
      padding: 8px;
    ...
    .accordion-menu-right {
      ...
      /* Separator for right menu */
    }

    /* Ensure empty menu containers don't take up space */
    .accordion-menu-left:empty,
    .accordion-menu-right:empty {
      padding: 0;
      border: none;
 ...
 Use bottom positioning + counter-rotation so it reads upright. */
    .accordion-tab {
      ...
      /* reserve space so icon doesn't overlap text */
    ...
    .accordion-tab::after {
      ...
      /* counter-rotate so symbol looks upright */
  ...
  <section class="gncPlacement-section container mb-5">
      ...
      <div class="placement-container">
        ...
        <div class="placement-content slide-right">
          ...
          <div class="placement-mini-stats">
            <div><strong>12 LPA</strong>
              <p>Offered by <span style="color: #fc8435;">20+</span> Companies</p>
            </div>
            <div><strong>8 LPA</strong>
              <p>Offered by <span style="color: #fc8435;">30+</span> Companies</p>
            </div>
            <div><strong>6 LPA</strong>
              <p>Offered by <span style="color: #fc8435;">70+</span> Companies</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <style>
      ...
      .btn-apply {
        background-color: #0f9af1 !important;
        color: #fff;
      }
      ...
      .placement-mini-stats strong {
        font-size: 16px;
        color: #000;
        display: block;
      }

      .placement-mini-stats p {
        font-size: 12px;
        color: #555;
        margin: 0;
      }
    ...
    <div class="why-content">
        ...
        <div class="why-answer">
          <div class="why-answer-inner">
            <div class="why-text-content">
              <h4 class="inner-question">Excellence in Every Endeavour 🌟</h4>
              <p>
                Guru Nanak College strives to cultivate excellence in academics,
                innovation, and personal growth. Through dedicated faculty,
                modern infrastructure, and value-based education, students are
                inspired to achieve their highest potential and contribute
      ...
      <div class="why-item">
        ...
        <div class="why-answer">
          <div class="why-answer-inner">
            <div class="why-text-content">
              <h4 class="inner-question">Your Career, Our Commitment 🎯</h4>
              <p>
                We focus on guiding students toward fulfilling careers through
                structured training, expert mentorship, and industry-integrated
                programs. Our Career Development Cell ensures every student
                gains confidence and exposure.
              </p>
            </div>
      ...
      <div class="why-item">
        ...
        <div class="why-answer">
          <div class="why-answer-inner">
            <div class="why-text-content">
              <h4 class="inner-question">Learning Beyond Classrooms 💡</h4>
              <p>
                Students engage in experiential learning, research, internships,
                and creative projects that build critical thinking and real-world
                skills.
              </p>
            </div>
      ...
      <div class="why-item">
        ...
        <div class="why-answer">
          <div class="why-answer-inner">
            <div class="why-text-content">
              <h4 class="inner-question">Global Outlook, Local Roots 🌏</h4>
              <p>
                Students gain global exposure while staying rooted in strong
      ...
      <div class="why-item">
        ...
        <div class="why-answer">
          <div class="why-answer-inner">
            <div class="why-text-content">
              <h4 class="inner-question">Where Potential Meets Opportunity 🎓</h4>
              <p>
                Guru Nanak College provides an environment where talent and
                opportunity come together to create lifelong success.
              </p>
            </div>
...
/* Hide original question text when open */
/* Hide only question text & arrow, NOT the number */
.why-item.active .why-text,
.why-item.active .arrow {
  visibility: hidden;
}

/* Keep number as background */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  accordions.forEach(item => {
    item.querySelector(".why-question").addEventListener("click", () => {
  ...
  <div class="mdublog-container">
    ...
    <div class="mdublog-wrapper">
      ...
      <div class="mdublog-side mdublog-left">
        <?php for ($i = 0; $i < 2; $i++):
          if (!isset($blogs[$i])) break;
          $b = $blogs[$i];
        ?>
        <a class="mdublog-card mdublog-small" href="<?= $b['link'] ?>">
          <div class="mdublog-img" style="background-image:url('<?= $b['image'] ?>')"></div>
          <div class="mdublog-content">
            <h3><?= $b['title'] ?></h3>
            <p class="mdublog-date"><?= $b['date'] ?></p>
          </div>
        </a>
        <?php endfor; ?>
      </div>
      ...
      <!-- FEATURED BLOG -->
      <?php if (isset($blogs[2])): $b = $blogs[2]; ?>
      <a class="mdublog-featured" href="<?= $b['link'] ?>">
        <div class="mdublog-featured-img" style="background-image:url('<?= $b['image'] ?>')"></div>
        <div class="mdublog-featured-content">
          <h2><?= $b['title'] ?></h2>
          <p class="mdublog-meta"><?= $b['date'] ?></p>
        </div>
      </a>
      <?php endif; ?>
...
.mdublog-title span { color: #0078ff; }
...
document.addEventListener("DOMContentLoaded", () => {
  const obs = new IntersectionObserver(entries => {
    entries.forEach(e => {
      if (e.isIntersecting) e.target.classList.add('mdublog-visible');
    });
  }, { threshold: 0.2 });

  document.querySelectorAll('.mdublog-left,.mdublog-right,.mdublog-featured')
