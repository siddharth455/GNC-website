...
<body>
 ...
 <section class="pageBanner-inner">
        <div style="background-image: url('upload/master-of-hospital-administration-head.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Hospital Administration</small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                                 <a href="upload/pdf/MHA.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best Master of Hospital Administration (MHA) College in Dehradun, Uttarakhand</h2>
                
                          <p>The Master of Hospital Administration (MHA) at the Guru Nanak College - Best Master of
                             Hospital Administration (MHA) College in Dehradun, Uttarakhand is an advanced postgraduate degree
                             that caters to individuals aiming to excel in healthcare administration and management. This two-year
                             program is designed to provide comprehensive training in the management and administration of
            ...
            <div class="hero-image-right">
                <img src="upload/master-of-healthcare-administrat.webp" alt="GNC Pharmacy Showcase">
            </div>
                ...
                <div class="col-data">
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">Minimum qualification required is graduation in any stream from any recognized board.<br>Minimum percentage required is 45% for GEN/OBC and 40% for SC/ST.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC MHA Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Hospital Administration (MHA)</h3>
                ...
                <p>Additionally, MHA graduates are equipped to lead in pharmaceutical project management and healthcare marketing, using their expertise to drive project success and improve public health messaging. High-level executive positions like hospital CEO or CFO are also achievable goals for MHA graduates, where they can make significant strategic decisions impacting healthcare delivery and operations.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">MHA Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Facility Management:</b> Leading hospital operations, healthcare facility management, and services management.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Consulting & Policy:</b> Roles in healthcare consulting, policy analysis, and patient safety coordination.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Financial & HR:</b> Specialized roles in healthcare financial management and human resources.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Health Systems:</b> Managing health information systems and public health administration.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Project Management:</b> Leading pharmaceutical projects and strategic healthcare marketing.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Executive Leadership:</b> Achieving high-level positions like Hospital CEO or CFO.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Master of Hospital Administration (MHA) in Dehradun?</h3>
