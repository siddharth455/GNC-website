            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>Graduates of the B.Sc. Forestry programs are equipped for diverse career paths in the forestry sector. They can find employment in government forest services, wildlife conservation organizations, and environmental NGOs. Opportunities also exist in forest-based industries for roles in sustainable resource management, timber production, and eco-tourism. Forestry graduates are also well-suited for research roles, contributing to studies on biodiversity, climate change, and forest ecology. Further academic pursuits in forestry or related fields can lead to careers in academia or specialized positions in forest policy and environmental consultancy.</p>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Science in Forestry</h2>
                            </div>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
            <li>Admission to the B.Sc. Forestry program at Guru Nanak College, Dehradun, is conducted through a merit-based selection process.</li>
                <li>Applicants are assessed based on their academic performance in the qualifying examination, followed by a counseling process to evaluate their passion and suitability for a career in forestry.</li>
            </ul>
        </div>
    </section>
                ...
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        ...
                        <li>A rich library with specialized resources in forestry and environmental science.</li>
                            ...
                            <li>We focus on holistic education, fostering skills such as critical thinking, ethical decision-making, and research aptitude. Our program also provides career counseling and placement support to assist students in navigating their career paths in forestry and environmental conservation.</li>
                            </ul>
