...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/optometry-head.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Optometry (B. Optom)</small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                                <!-- <a href="upload/pdf/opto.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a> -->
                            </div>
                        </div>
            ...
            <div class="flex-container">
                ...
                <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/RqpEYUvQKG4?autoplay=1&mute=1&playlist=RqpEYUvQKG4&loop=1" title="BSC Optometry Program Video" allowfullscreen></iframe>
                    </div>
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                ...
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Foundations:</b> The curriculum of a BSc Optometry program typically includes courses in anatomy and physiology.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Core Sciences:</b> In-depth study of optics and pharmacology essential for eye care professionals.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Ocular Health:</b> Specialized courses in binocular vision and the study of ocular disease.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Practice:</b> Students receive clinical training in optometry procedures and techniques.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Specialized Skills:</b> Hands-on training including refraction and contact lens fitting.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Rehabilitation:</b> Focused training on visual rehabilitation to prepare students for clinical excellence.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Optometry (BSc Optometry) in Dehradun?</h3>
                    <p>Optometry, part of Guru Nanak College's School of Paramedical Sciences, Dehradun, focuses on excellence in health sciences education.</p>
