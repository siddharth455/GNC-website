...
<head>
    ...
    <meta property="og:title" content="Best Operation Theatre Technology College in Dehradun | GNC" />
...
@media (max-width: 768px) {
    .career-glass-grid { grid-template-columns: 1fr; }
        ...
        .why-join-blue {
            background: linear-gradient(90deg, rgb(11, 87, 138) 30%, rgba(30, 34, 82, .1)), url('upload/programs/Bsc-ott.JPG') !important;
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/Operation_Theatre_head.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                ...
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                 ...
                                 <a href="upload/pdf/ott.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
  ...
  <section class="hero-section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 animate__animated animate__fadeIn">
                        ...
                        <h1 class="display-6 fw-300 my-1">Guru Nanak College - Best BOTT College in Dehradun, Uttarakhand <span style="color:var(--accent)">Uttarakhand</span></h1>
                       <p class="lead text-muted">The Bachelor of Operation Theatre Technology (BOTT) is a specialized undergraduate program designed for those aspiring to be integral members of surgical teams in healthcare settings. This course offers in-depth knowledge and hands-on training in managing operation theatres, understanding surgical procedures, handling sophisticated equipment, and assisting in complex surgeries. Students learn crucial aspects of anesthesia technology, surgical instrumentation, patient monitoring, and operation theatre management, ensuring a sterile and safe environment during surgeries.</p>
                      <p class="lead text-muted">Many BOTT graduates find their niche in administrative roles, such as Hospital Operation Theatre Managers, overseeing the operation theatre department, managing staff, and ensuring compliance with healthcare regulations. Their in-depth knowledge of operation theatre technology also makes them valuable consultants for medical equipment manufacturers, contributing to the design and functionality of surgical tools.</p></p>
                    </div>
          ...
          “ The BOTT program focuses on preparing students to assist in surgical procedures and manage operation theatre environments efficiently. With hands-on experience in surgical instruments, sterilization techniques, and patient care, students are trained to play a critical role in ensuring safe and successful surgeries.”
         </p>
                ...
                <div class="col-data">
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">The students who have passed 10+2 or had given senior secondary examination with Maths/Biology/Agriculture from any recognized board.</p>
                            
                            <p style="font-size: 0.9rem; line-height: 1.5;">The minimum percentage required is 45% for GENERAL/OBC and 40% for ST/SC.</p>
        ...
        <div class="row g-0 shadow-lg rounded-4 overflow-hidden border scroll-reveal">
            ...
            <div class="col-lg-7 bg-white p-4 p-md-5">
                ...
                <div class="practice-list-container">
                    <?php
                    $practices = [
                        "Emphasis on sterile techniques and operation theatre protocols.",
                        "Hands-on training in surgical procedures and OT equipment handling.",
                        "Case-based learning in pre-operative and post-operative care.",
                        "Integration of theory with real-time surgical assistance.",
                        "Training with advanced surgical instruments and anesthesia support systems.",
                        "Team-based learning for effective coordination in operation theatres.",
                        "Outcome-based training focused on patient safety and surgical efficiency.",
                        "Experienced faculty with strong clinical and surgical background."
                    ];
                ...
                <div class="assessment-quote mt-4 p-3 rounded-3 scroll-item">
                    <p class="mb-0 x-small text-muted">
                        ...
                        <strong>Assessment Methods:</strong> Practical demonstrations, OT simulations, case evaluations, viva, and continuous clinical assessment.
                    </p>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="empower-card mb-3 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fw-bold mb-0 small">OT Clinical Exposure</h6>
                                <p class="x-small text-muted mb-0">Hands-on training in live surgeries at affiliated hospitals.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="empower-card mb-3 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="x-small text-muted mb-0">Workshops in anesthesia technology, surgical assistance, and infection control.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="empower-card mb-4 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fw-bold mb-0 small">Hospital Exposure</h6>
                                <p class="x-small text-muted mb-0">Experience multidisciplinary teamwork in operation theatre environments.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="empower-card mb-4 p-3 scroll-item shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="x-small text-muted mb-0">Encouraging research in surgical techniques and OT management practices.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-2 scroll-item">
                        <div class="col-6">
                            <div class="p-2 border rounded-3 bg-white text-center">
                                ...
                                <span class="x-small text-uppercase fw-bold text-muted">Operation Theatres</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-2 border rounded-3 bg-white text-center">
                                <span class="d-block fw-bold text-theme h5 mb-0">100%</span>
                                <span class="x-small text-uppercase fw-bold text-muted">Surgical Training</span>
                            </div>
                        </div>
                    </div>
...
<section class="gnc-bmrit-wrapper">
    <div class="container-fluid px-lg-5">
        ...
        <div class="text-center mb-5 bmr-reveal">
            <h2 class="fw-extrabold display-5 mb-2" style="color: #0f9af1;">Career Prospects After BOTT</h2>
            <p class="fw-bold text-uppercase tracking-wider" style="color: #fb7b1c;">Build a Career in Surgical & Operation Theatre Management</p>
        </div>
            ...
            <div class="col-lg-6 bmr-reveal">
                <div class="career-glass-grid">
                    ...
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            <h6>Operation Theatre Technologist</h6>
                            <span>Assist surgeons and manage OT procedures during surgeries.</span>
                        </div>
                    </div>

                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-syringe"></i></div>
                        <div class="node-text">
                            <h6>Anesthesia Technician</h6>
                            <span>Support anesthesiologists in administering anesthesia.</span>
                        </div>
                    </div>

                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-hospital"></i></div>
                        <div class="node-text">
                            <h6>OT Assistant</h6>
                            <span>Prepare operation theatres and assist during surgical procedures.</span>
                        </div>
                    </div>

                    <div class="career-node bmr-item">
                        <div class="node-icon"><i class="fa-solid fa-briefcase-medical"></i></div>
                        <div class="node-text">
                            <h6>Surgical Equipment Specialist</h6>
                            <span>Handle and maintain advanced surgical instruments and devices.</span>
                        </div>
                    </div>
                    ...
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            <h6>OT Manager</h6>
                            <span>Oversee operation theatre management and workflow.</span>
                        </div>
                    </div>
                    ...
                    <div class="career-node bmr-item">
                        ...
                        <div class="node-text">
                            ...
                            <span>Teach and train future OT technologists.</span>
                        </div>
                    </div>
                ...
                <div class="gnc-benefits-card bmr-item">
                    ...
                    <div class="benefits-content p-4">
                        <div class="benefit-row">
                            ...
                            <p><strong>Advanced OT Labs:</strong> Train in simulated operation theatre environments.</p>
                        </div>
                        <div class="benefit-row">
                            <i class="fa-solid fa-circle-check"></i>
                            <p><strong>Clinical Exposure:</strong> Assist in real surgeries at multispeciality hospitals.</p>
                        </div>
                        <div class="benefit-row">
                            <i class="fa-solid fa-circle-check"></i>
                            <p><strong>Expert Faculty:</strong> Learn from experienced surgeons and OT professionals.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Operation Theatre Technology (BOTT)</h3>
                <p>Graduates of the Bachelor of Operation Theatre Technology (BOTT) have a diverse range of career opportunities in the healthcare sector. As Operation Theatre Technologists, they are pivotal in assisting surgeons and anesthesiologists, managing surgical equipment, and maintaining sterile conditions in operation theatres.</p>
                <p>Their expertise is also crucial in roles such as Surgical Equipment Technicians, where they handle the maintenance and operation of sophisticated surgical tools.</p>
            </div>

           
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">Core Professional Roles</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Surgical Assistance:</b> Pivotal roles in assisting surgeons and anesthesiologists during complex procedures.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Equipment Management:</b> Expertly managing surgical equipment to ensure seamless operation theatre workflows.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Sterilization Control:</b> Maintaining sterile conditions in operation theatres to prevent infections.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Technical Expertise:</b> Working as Surgical Equipment Technicians in advanced medical facilities.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Maintenance:</b> Handling the maintenance and operation of sophisticated surgical tools and machinery.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Support:</b> Ensuring patient safety and operational efficiency within the healthcare sector.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Operation Theatre Technology (BOTT) in Dehradun?</h3>
                    <p>OTT, part of Guru Nanak College's School of Paramedical Sciences, Dehradun, delivers excellence in health sciences education.</p>
