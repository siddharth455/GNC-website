...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://www.gnc.edu.in/pharmacy-college">
</head>
<body>
    ...
    <div class="swiper banner-slider">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="assets/image/banner-4.webp" alt="DIS Mobile Banner" class="banner-image w-100" width="auto" height="auto">
...
<section class="kc-scholarship-benefits" aria-labelledby="kc-scholarship-title">
 ...
 <section id="programs" class="py-5 ">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold text-white" data-aos="fade-up">Our Pharmacy Courses</h2>

    <!-- Filter Buttons -->
     <div class="text-center mb-4" data-aos="fade-up" data-aos-delay="100">
      <!-- <div class="btn-group flex-wrap">
        <button class="btn btn-outline-primary filter-btn active" data-filter="pharmacy">Pharmacy</button>
      </div> -->
    </div>
    ...
    <div class="row g-4 course-container">
      ...
      <div class="col-md-4 filter-item pharmacy" data-aos="zoom-in">
        <div class="card course-card h-100">
          ...
          <p class="card-text" style="color: #212529 !important;">3 Years | Fee: ₹85,000 /- year (Included Power Degree Fee)</p>
         <div class="text-center mt-auto">
              <a href="#" class="btn btn-primary apply-now-btn mt-2 w-50">Apply Now</a>
            </div> 
        </div>
      ...
      <div class="col-md-4 filter-item pharmacy" data-aos="zoom-in">
        <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">2 Years | Fee: ₹65,000 /- year (Included Power Degree Fee)</p>
            <div class="text-center mt-auto">
              <a href="#" class="btn btn-primary apply-now-btn mt-2 w-50">Apply Now</a>
            </div>
          </div>
...
<script>
  ...
  const showMoreSchools = ["pharmacy"];
