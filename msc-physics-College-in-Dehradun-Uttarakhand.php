      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best M.Sc in Physics College in Dehradun, Uttarakhand</h2>
                  <p>The Master of Science in Physics program at Guru Nanak College, Dehradun is a
postgraduate course designed for students who are passionate about exploring the fundamental
principles of the universe. This two-year program delves into advanced concepts of theoretical and
applied physics, covering areas such as quantum mechanics, classical mechanics, electromagnetism,
thermodynamics, and nuclear physics.</p>
                        <p>The curriculum of the M.Sc. Physics program is designed to provide a deep understanding of physical
laws and theories, along with practical skills in experimental physics. It includes subjects like solid state
physics, particle physics, astrophysics, and statistical mechanics. The program also emphasizes research
methodologies, enabling students to undertake significant research projects in various specializations of
physics.</p>
                ...
                <div class="col-data">
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">Minimum qualification required is graduation from any recognized university.<br>Minimum percentage required is 45% for GEN/OBC and 40% for SC/ST.</p>
    ...
    <div class="gnc-bento-container">
        ...
        <div class="right-stack">
            ...
            <div class="gnc-bento-item bg-light-grey" style="flex: 1;" data-aos="fade-right" data-aos-duration="800">
                ...
                <p>Admission to the M.Sc. Physics program at Guru Nanak College, Dehradun, typically involves a merit-based selection process. Candidates are evaluated based on their performance in their undergraduate degree, preferably with a major in physics</p>
                <p>The college may also conduct counseling sessions to assess candidates' understanding of fundamental physics concepts and their aptitude for advanced studies in the field.</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC M.Sc. Physics Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Physics (M.Sc. Physics)</h3>
                <p>Graduates of the M.Sc. Physics program can pursue a variety of career paths in academia, research, and industry. They can work as physicists in research institutions, laboratories, and technology companies. Opportunities also exist in educational institutions as teachers or lecturers.</p>
                
                <p>Graduates can engage in roles in the aerospace, defense, and energy sectors, applying their knowledge of physics to practical challenges. Further academic pursuits, such as a Ph.D. in Physics, can lead to careers in advanced research and university-level teaching.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">M.Sc. Physics Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Physicists:</b> Working in research institutions, laboratories, and technology companies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Education:</b> Career opportunities in educational institutions as teachers or lecturers.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Industrial Sectors:</b> Engaging in roles within the aerospace, defense, and energy sectors.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Applied Physics:</b> Applying deep knowledge of physics to solve complex practical challenges.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Advanced Research:</b> Pursuing Ph.D. pathways leading to specialized scientific research roles.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Higher Academia:</b> Qualifying for university-level teaching and academic leadership positions.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Master of Science in Physics in Dehradun?</h3>
                    <p>The M.Sc. Physics program at Guru Nanak College offers several advantages:</p>

                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive curriculum that covers a wide range of physics topics, offering both breadth and depth of knowledge.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Access to well-equipped laboratories and modern facilities for experimental physics.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Experienced faculty with expertise in various physics sub-disciplines.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Opportunities for students to engage in research projects, enhancing their analytical and problem-solving skills.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A focus on preparing students for a career in scientific research or academia, with the necessary skills and knowledge to succeed in the field of physics.</p>
                            </div>
                        </li>
                    </ul>
                    
                    <p class="text-white">The program is designed to provide students with a solid foundation in physics, preparing them for diverse professional roles or further academic pursuits. With its blend of rigorous theoretical learning and practical experimentation, the M.Sc. Physics program at Guru Nanak College is an excellent choice for students aspiring to become leaders in the field of physics.</p>
