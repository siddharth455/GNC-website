...
<head>
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "item": {
                    "@type": "Course",
                    "name": "Bachelor of Medical Radio Diagnosis & Imaging Technology (BMRIT)",
                    "url": "https://www.gnc.edu.in/Best-BMRIT-bachelor-in-medical-radioimagingtechnology-college-in-dehradun.php",
                    "description": "Bachelor of Medical Radio Diagnosis & Imaging Technology (BMRIT) offered by Guru Nanak College, Dehradun, Uttarakhand — affiliated with Hemwati Nandan Bahuguna Garhwal University (HNBGU) / Uttarakhand Technical University (UTU).",
                    "provider": {
                ...
                "item": {
                    ...
                    "url": "https://www.gnc.edu.in/Best-operation-theatre-technology-colleges-indehradun.php",
                    "description": "Bachelor of Operation Theatre Technology (BOTT) offered by Guru Nanak College, Dehradun, Uttarakhand — affiliated with Hemwati Nandan Bahuguna Garhwal University (HNBGU) / Uttarakhand Technical University (UTU).",
                    "provider": {
                        "@type": "CollegeOrUniversity",
                        "name": "Guru Nanak College",
                        "url": "https://www.gnc.edu.in/",
                ...
                "item": {
                    ...
                    "url": "https://www.gnc.edu.in/masters-in-lab-technician.php",
                    "description": "Master of Medical Laboratory Technology (MMLT) offered by Guru Nanak College, Dehradun, Uttarakhand — affiliated with Hemwati Nandan Bahuguna Garhwal University (HNBGU) / Uttarakhand Technical University (UTU).",
                    "provider": {
                        "@type": "CollegeOrUniversity",
                        "name": "Guru Nanak College",
                        "url": "https://www.gnc.edu.in/",
    ...
    <style>
        ...
        .gnc-container-wide {
            padding-left: clamp(20px, 10vw, 188px);
            padding-right: clamp(20px, 10vw, 188px);
        }
        ...
        .gnc-img-swiper .swiper-slide img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        }
        ...
        <div class="container">
            <div class="mb-4">
                <span class="badge bg-black p-2 px-3 fw-bold border border-secondary">
                    ...
                    <i class="fas fa-chevron-right mx-1 small"></i> Paramedical Sciences
                </span>
            </div>
                    ...
                    <div class="swiper gnc-feature-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gnc-feature-item"><span>01</span>
                                    <p>Paramedical Sciences encompasses numerous fields like BMLT, OTT, Physiotherapy, and more.</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gnc-feature-item"><span>02</span>
                                    <p>Comprehensive insights with an explicit practice-oriented approach and in-depth exposure to clinical methodologies.</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gnc-feature-item"><span>03</span>
                                    <p>Appropriate tactics are undertaken to discharge medical and laboratory responsibilities efficiently.</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gnc-feature-item"><span>04</span>
                                    <p>Grow as per your capabilities with regular clinical workshops, seminars, and medical projects.</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gnc-feature-item"><span>05</span>
                                    <p>Multidisciplinary Faculty from diverse medical backgrounds to give your learning a wider perspective.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="p-4 border rounded-3 h-100 hover-shadow transition d-flex flex-column">
                                ...
                                <ul class="list-unstyled small fw-bold text-secondary space-y-2">
                                    ...
                                    <li><i class="fas fa-check-circle text-info me-2"></i>Specialization: Renal Care</li>
                                </ul>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="p-5 border rounded-3 h-100 hover-shadow transition d-flex flex-column">
                                    <h4 class="fw-black mb-4">Master of Medical Laboratory Technology (MMLT)</h4>
                            ...
                            <div class="col-md-6">
                                <div class="p-5 border rounded-3 h-100 hover-shadow transition d-flex flex-column">
                                    <h4 class="fw-black mb-4">Master of Physiotherapy (MPT)</h4>
                                    <ul class="list-unstyled fw-bold text-secondary mb-4 space-y-3">
                                        <li><i class="fas fa-clock text-info me-2"></i>Duration: 2 Years</li>
            ...
            <div class="bg-gnc-blue p-5 rounded-4 text-white shadow-xl">
                <div class="row align-items-center">
                    <div class="col-lg-8 text-start">
                        ...
                        <p class="mb-4 fw-bold">Admissions for Undergraduate and Postgraduate Paramedical Courses are now open for the 2026 academic session.</p>
                        <ol class="fw-bold space-y-2">
                            <li>Apply online at www.gnc.edu.in</li>
                        ...
                        <p class="mt-4 fw-black">Contact for Admission: admission@gnc.edu.in | +91-7300900900</p>
                    </div>
                    <div class="col-lg-4">
                        <a href="https://application.gnc.edu.in/" class="btn btn-light btn-lg w-70 py-3 fw-black text-info shadow-lg">START APPLICATION</a>
                    </div>
                </div>
            </div>
        </div>
