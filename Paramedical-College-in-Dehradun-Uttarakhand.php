...
<link rel="icon" type="image/webp" href="images/logog.webp">
    ...
    <style>
        ...
        /* FAQ Styling */
        .faq-accordion .accordion-item { border: none; margin-bottom: 15px; border-radius: 8px !important; box-shadow: 0 4px 15px rgba(0,0,0,0.05); overflow: hidden; }
        .faq-accordion .accordion-button { font-weight: 800; color: var(--text-dark); padding: 25px; background: #fff; border: none; }
        .faq-accordion .accordion-button:not(.collapsed) { background: #fff; color: var(--gnc-blue); box-shadow: none; }
        .faq-accordion .accordion-body { padding: 30px; color: #666; line-height: 1.8; font-size: 15px; }
        ...
        @media (max-width: 576px) {
            ...
            .faq-accordion .accordion-button { padding: 16px; }
            .faq-accordion .accordion-body { padding: 16px; }
