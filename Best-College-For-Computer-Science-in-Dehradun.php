        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <h4>Under-Graduate Computer Science Course's</h4>
                    <ul class="listStyle-2 p-0 mt-4 text-start course-list ps-4">
                        <li><a href="https://gnc.edu.in/Best-College-for-BCA-in-Dehradun-Uttarakhand">Bachelor of Computer Applications</a></li>
                    </ul>
    ...
    <section style="background-color: #00b7ff;">
        <div class="container pt-5 pb-5 ">
            <div class="row"> <!-- Adjusted: Added align-items-center class -->
                ...
                <div class="col-lg-3">
                    <img src="upload/hero/cs-4.webp" style="width:-webkit-fill-available;border-radius: 10px;"> <!-- Adjusted: Added display: block; margin: 0 auto; to center the image -->
                </div>
            </div>
        </div>
    </section>
