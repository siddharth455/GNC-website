...
<head>
    ...
    <title>Guru Nanak College | Best Master of Optometry college in Dehradun, Uttarakhand.</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Explore the premier Master of Optometry program at Guru Nanak College in Dehradun, Uttarakhand Offering cutting-edge training, experienced faculty, and state-of-the-art facilities, GNC prepares students for successful careers in optometry.">
    <link rel="canonical" href="https://www.gnc.edu.in/master-of-optometry">
    ...
    <meta property="og:description" content="Explore the premier Master of Optometry program at Guru Nanak College in Dehradun, Uttarakhand Offering cutting-edge training, experienced faculty, and state-of-the-art facilities, GNC prepares students for successful careers in optometry." />
    <meta property="og:url" content="https://www.gnc.edu.in/master-of-optometry" />
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/opto-banner.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Optometry (M. Optom)</small></h3>
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Guru Nanak College - Best Master of Optometry (M. Optom) College in India</h2>
                        </div>
                        <p>A Master of Optometry (M. Optom) is a two-year postgraduate program designed to advance the knowledge and skills of eye care professionals. This program focuses on the diagnosis, treatment, and management of complex eye conditions, as well as providing services such as vision testing, prescribing corrective lenses, and offering specialized care for visual disorders. Optometry is a crucial healthcare field dedicated to enhancing vision health and preventing eye-related issues.</p>
                        ...
                        <p>
                        The college offers modern, well-equipped laboratories and cutting-edge medical equipment, providing students with practical experience in a real-world environment to prepare them for their careers. With strong industry connections, the college offers students opportunities for internships and placements at prominent healthcare institutions. This exposure helps them stay current with the latest technologies and trends, ensuring they become highly sought-after professionals. The institution's focus on delivering quality education at an affordable cost is a key highlight, making it an attractive choice for aspiring healthcare professionals.
                        </p>
                        <p>The curriculum of an M. Optom program typically includes advanced courses in ocular disease, contact lens management, binocular vision, low vision, pharmacology, and ocular therapeutics. Students also undergo extensive clinical training, refining their skills in optometric procedures, advanced refraction techniques, diagnostic imaging, and the management of complex visual disorders.</p>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/opto-image.webp" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Master of Optometry (M. Optom)</h2>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <li>Bachelor's degree in Optometry (B. Optometry) or equivalent from a recognized university.</li>
