...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/mmlt.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    ...
                                    <h3 class="mb-1 mt-3">Medical Laboratory Technician</small></h3>
                                </div>
                                <a href="https://application.gnc.edu.in/" target="_blank" class="cu-btn cu-btn-100 text-center mt-2 mb-2">
                                    Apply Now

                                </a>
                                <a href="upload/pdf/MMLT.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-data">
                    ...
                    <div class="tab-content" id="gncTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="fee-content" role="tabpanel">
                            ...
                            <p style="font-size: 0.9rem; line-height: 1.5;">Bachelor's degree in Physiotherapy (BPT) or equivalent from a recognized university. Min. 50% marks for general and 45% marks in case of SC/ST category</p>
            ...
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                ...
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Clinical Laboratories:</b> Working in hospitals or private diagnostic labs as medical laboratory technologists.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Blood Banks:</b> Handling the processing, testing, and storage of blood and its components.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Pharma R&D:</b> Contributing to research and development for innovative drugs and medical therapies.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Quality Control:</b> Ensuring the safety and effectiveness of various pharmaceutical products.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Academic Roles:</b> Training future medical laboratory professionals in educational institutions.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Advanced Research:</b> Engaging in high-level medical research in specialized research institutions.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Master of Medical Laboratory Technology (MMLT) in Dehradun?</h3>
                    <p>MMLT, part of Guru Nanak College's School of Paramedical Sciences, Dehradun, we are dedicated to providing top-tier education in health sciences.</p>
