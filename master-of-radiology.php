...
<link rel="icon" type="image/webp" href="images/logog.webp">
    <title>Guru Nanak College | Best Master of Medical Radio Diagnosis And Imaging Technology College in Dehradun, Uttarakhand.</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Discover the top Master of Medical Radiology & Imaging Technology (MMRIT) program at GNC College in Dehradun, Uttarakhand. Offering advanced curriculum, hands-on training, and expert faculty, GNC prepares students for successful careers in radiology and medical imaging.">
    <link rel="canonical" href="https://gnc.edu.in/master-of-radiology">
    ...
    <meta property="og:description" content="Discover the top Master of Medical Radiology & Imaging Technology (MMRIT) program at GNC College in Dehradun, Uttarakhand. Offering advanced curriculum, hands-on training, and expert faculty, GNC prepares students for successful careers in radiology and medical imaging." />
    <meta property="og:url" content="https://gnc.edu.in/master-of-radiology" />
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/hero/mmlt-banner.webp'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>Graduates of the Master of Medical Radio Diagnosis and Imaging Technology (MMRIT) have diverse career opportunities in healthcare, specializing in advanced medical imaging and diagnostics. They are primarily employed in hospitals, managing and operating imaging equipment such as MRI and CT scanners, contributing significantly to patient care. Additionally, diagnostic centers and outpatient clinics offer employment, where MMRIT graduates work closely with radiologists to analyze and interpret complex imaging results.</p>
                        <p>Beyond traditional roles, MMRIT graduates can specialize in advanced fields such as interventional radiology or mammography, often with additional training. The domain also provides opportunities in research and development, driving innovation in imaging technology and techniques.</p>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Master of Medical Radio Diagnosis And Imaging Technology <br>(MMRIT)</h2>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <li>Bachelor's degree in Medical and Radiology Technology (BMRIT) or equivalent from a recognized university.</li>
