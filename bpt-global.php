...
<head>
    ...
    <title>BPT Global Track | Bachelor of Physiotherapy Global | Guru Nanak College Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="BPT Global Track at Guru Nanak College Dehradun, in partnership with Career Buddy College. Same IAP-recognized physiotherapy degree, plus international hospital exposure in Dubai, China, Singapore, Japan & Germany.">
    <!-- Open Graph Tags -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="BPT Global Track | Bachelor of Physiotherapy Global | Guru Nanak College Dehradun" />
    <meta property="og:description" content="BPT Global Track at Guru Nanak College Dehradun, in partnership with Career Buddy College. Same IAP-recognized physiotherapy degree, plus international hospital exposure in Dubai, China, Singapore, Japan & Germany." />
        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <h1>Go Global With Your <span>Physiotherapy Career</span></h1>
                    <p class="lead">Since 2009, Guru Nanak College has been building IAP-recognized physiotherapists in Dehradun. The Bachelor of Physiotherapy (BPT) Global Track — delivered with our industry partner Career Buddy College — adds structured international hospital exposure across Dubai, China and Singapore, plus a dedicated Japan/Germany career pathway, on top of your regular GNC BPT degree.</p>
    ...
    <section class="gl-section-padding gl-partner-section">
        <div class="container position-relative">
            <div class="gl-partner-box gl-reveal-scale">
                ...
                <p>Guru Nanak College, Jhajhra, Chakrata Road, Dehradun, has been shaping physiotherapy and healthcare professionals since 2009, with programs recognized by the Indian Association of Physiotherapists (IAP). Career Buddy College is our industry-facing partner for this track — bringing international hospital exposure, language training and global placement support. Together, they power the Global Learning Track for our BPT students, without changing who awards your degree or runs your core curriculum. GNC's Global Learning Track also covers <a href="nursing-global">B.Sc Nursing</a> and <a href="gnm-global">GNM</a> — see the <a href="global-learning">full Global Learning overview</a>.</p>
    ...
    <section class="gl-section-padding">
        <div class="container">
            <div class="text-center mx-auto mb-5 gl-reveal" style="max-width:700px;">
                <span class="gl-kicker">Same GNC BPT Degree, More Behind It</span>
                <h2 class="gl-heading">What The Global Track Actually Adds</h2>
                <p class="gl-sub mx-auto">Every GNC BPT student already gets IAP-recognized training and access to our Career Development Cell, which brings 100+ recruiting companies to campus each year. The BPT Global Track sits on top of that — it doesn't replace your regular programme, it adds four years of structured international exposure to it. Here's the side-by-side.</p>
            </div>
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="gl-compare-card gl-pro gl-reveal-left">
                        <h4><i class="fa-solid fa-globe me-2"></i>GNC BPT Global Track</h4>
                        <ul>
                            <li><i class="fa-solid fa-circle-check"></i> The same IAP-recognized GNC BPT degree, with a guided international layer added on</li>
                ...
                <div class="col-md-6">
                    <div class="gl-compare-card gl-con gl-reveal-right">
                        <h4><i class="fa-solid fa-circle-minus me-2"></i>The Regular GNC BPT Programme</h4>
                        <ul>
    ...
    <section class="gl-section-padding" id="gl-journey" style="background:#f8fafc;">
        <div class="container">
            <div class="text-center mx-auto mb-5 gl-reveal" style="max-width:700px;">
                ...
                <h2 class="gl-heading">Your BPT Global Learning Journey at GNC</h2>
                <p class="gl-sub mx-auto">You remain a GNC BPT student throughout — attending classes, clinicals and exams on our Dehradun campus every semester. What changes is that each year of your degree, we add a short, faculty-accompanied international exposure module, planned jointly by GNC's academic team and Career Buddy College. Here's how the four years actually break down.</p>
            </div>
    ...
    <section class="gl-section-padding">
        <div class="container">
            <div class="text-center mx-auto mb-5 gl-reveal" style="max-width:700px;">
                ...
                <h2 class="gl-heading">Your BPT Global Track</h2>
                <p class="gl-sub mx-auto">An IAP-recognized, globally aligned Bachelor of Physiotherapy program at GNC Dehradun, built to make you internationally job-ready from day one.</p>
            </div>
            ...
            <p class="text-center gl-sub mx-auto mt-4" style="max-width:640px;">Looking for a different program? Explore the <a href="nursing-global">B.Sc Nursing Global Track</a>, the <a href="gnm-global">GNM Global Track</a>, or the <a href="global-learning">full Global Learning overview</a>.</p>
        </div>
    </section>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#glFaq1">
                                    What does the BPT Global Track actually include?
                                </button>
                            </h2>
                            <div id="glFaq1" class="accordion-collapse collapse show" data-bs-parent="#glFaqAccordion">
                                <div class="accordion-body">It is a structured, year-wise international exposure pathway built into your regular GNC BPT degree — covering hospital visits and clinical exposure in Dubai, China and Singapore, plus a dedicated language and placement-focused career track for Japan/Germany in the final year.</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                            ...
                            <div id="glFaq2" class="accordion-collapse collapse" data-bs-parent="#glFaqAccordion">
                                <div class="accordion-body">No. Bachelor of Physiotherapy, <a href="nursing-global">B.Sc Nursing</a> and <a href="gnm-global">GNM (General Nursing & Midwifery)</a> at GNC all offer the Global Learning Track as an add-on to their regular curriculum. This page focuses on the BPT track.</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
    ...
    <section class="gl-section-padding">
        <div class="container">
            <div class="gl-cta gl-reveal-scale">
                ...
                <h3>Ready to Build a Global Physiotherapy Career?</h3>
                <p>Limited seats available for the 2026 batch under the BPT Global Track, in partnership with Career Buddy College. Call our Admission Helpline at 7300900900 or apply online.</p>
                <a href="#gl-apply-form" class="gl-btn-gold">Apply Now <i class="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </section>
