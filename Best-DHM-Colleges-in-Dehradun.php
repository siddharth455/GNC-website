...
<link rel="icon" type="image/webp" href="images/logog.webp">
    <title>Guru Nanak College | Best Diploma in Hotel Management College in Dehradun, Uttarakhand</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-12 about-program-image">
                        <img src="upload/Diploma in Hotel Management.webp" alt="hotel management showcase" loading="lazy" style="width: -webkit-fill-available;">
                    </div>
                </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Diploma in Hotel Management</h2>
                            </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Fee</td>
                                                        <td>70,000 /- (Included Power Degree Fee)</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>70,000 /- (Included Power Degree Fee)</b></td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        <div class="page-heading">
                            <h3>Why Join Guru Nank College For Diploma in Hotel Management (D.HM) in Dehradun?</h3>
                        </div>
