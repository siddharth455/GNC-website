...
<head>
    ...
    <title>Guru Nanak College | Vision & Mission</title>
    <meta name="description" content="Guru Nanak College Dehradun, committed to empowering students with knowledge
and values for a brighter future. We strive to create a vibrant learning environment that combines
academic excellence with industry relevance and personal development.">
    <link rel="canonical" href="https://www.gnc.edu.in/vision-mission">
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Guru Nanak College Dehradun, committed to empowering students with knowledge
and values for a brighter future. We strive to create a vibrant learning environment that combines
academic excellence with industry relevance and personal development." />
    <meta property="og:description" content="Guru Nanak College Dehradun, committed to empowering students with knowledge
and values for a brighter future. We strive to create a vibrant learning environment that combines
academic excellence with industry relevance and personal development." />
...
<body>
    ...
    <section class="pageBanner-inner">
        <div style="background-image: url('upload/infra/vission-banner.webp'); background-repeat: no-repeat; background-size: cover;">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                <div class="upper-banner-content">
                                    <h3 class="mb-1 mt-3">Vision & Mission <br><small>GNC offer a brand new approach to the most basic things.<br>The wide range of learning options allows our students to<br>select the most convenient and effective course!</small></h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section-background mt-5" style="background: url('images/vision-mission-corevalue.w');">
        <div class="vison-sec">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="vision-block mt-5" style="background-image: url(images/core-value);background-repeat: no-repeat;background-position: center; border-radius: 10px;">
                            <div class="main-heading-vision">
                                <div class="row">
                                    <div class="col-8">
                                        <h2 data-orig-font="56px" style="font-size: 56px;">Core Values</h2>
                                        <h6>Our educational philosophy and practice</h6>
                                    </div>
                                    <div class="col-4">
                                        <!-- <img src="images/core-value.png" alt="Core Value of BFIT"> -->
                                    </div>
                                </div>
                            </div>
                            <ul>
                                ...
                                <li>Ethical behavior and integrity, guided by the teachings of Guru Nanak College , are fundamental to our institution. We strive to create leaders who are not just successful in their fields but also mindful of their ethical responsibilities. Our employees are expected to uphold these values, creating a trustworthy and respectful workplace.</li>
                                ...
                                <li>Ethical conduct, inspired by the teachings of Guru Nanak College , underpins all our operations, ensuring integrity in our academic and administrative activities.</li>
                            </ul>
                        </div>
                    </div>
                </div>
