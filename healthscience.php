...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://www.gnc.edu.in/healthscience">
</head>
<body>
...
<section class="kc-scholarship-benefits" aria-labelledby="kc-scholarship-title">
 ...
 <section id="programs" class="py-5 ">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold text-white" data-aos="fade-up">Our Healh Science Courses</h2>

    <!-- Filter Buttons -->
     <div class="text-center mb-4" data-aos="fade-up" data-aos-delay="100">
      <!-- <div class="btn-group flex-wrap">
        <button class="btn btn-outline-primary filter-btn active" data-filter="health">Health Science</button>
      </div> -->
    </div>
    ...
    <div class="row g-4 course-container">
      ...
      <div class="card course-card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text" style="color: #212529 !important;">2 Years | Fee: ₹70,000/ (+20,000 optional for Power Degree)year</p>
...
<script>
  ...
  const showMoreSchools = ["health"];
  let currentFilter = 'health';
