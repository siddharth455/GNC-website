...
<head>
    ...
    <title>Guru Nanak College | Best Bachelor of Medical Radio Diagnosis And Imaging Technology College in Dehradun, Uttarakhand.</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/HiXcKSz8fJM?autoplay=1&mute=1&playlist=HiXcKSz8fJM&loop=1"
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Medical Radio Diagnosis And Imaging Technology <br>(BMRIT)</h2>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        <div class="page-heading">
                            <h3>Why Join Guru Nank College For Bachelor of Medical Radio Diagnosis And Imaging Technology(BMRIT) in Dehradun ?</h3>
                        </div>
                        <p>BMRIT, part of Guru Nanak College's School of Paramedical Sciences, Dehradun, delivers excellence in health sciences education.</p>
                        <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
