                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-xl-7">
                            <div class="pageBanner-inner__content inner-content head-sm text-md-start">
                                ...
                                <a href="upload/pdf/BSc-Foodtech.pdf" target="_blank" id="printButton1" target="_blank" class="cu-btn cu-btn-100 cu-btn-white bg-danger text-center mt-0">
                                    Download Brochure
                                </a>
                            </div>
                        </div>
      ...
      <div class="main-container">
        <div class="hero-layout">
            ...
            <div class="hero-content-left">
                <h2>Guru Nanak College - Best B.Sc Biotechnology College in Dehradun, Uttarakhand</h2>
            ...
            <div class="flex-container">
                ...
                <div class="col-video">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/2YrZ-YwPMc0?autoplay=1&mute=1&playlist=2YrZ-YwPMc0&loop=1" title="BSC Biotechnology Program Video" allowfullscreen></iframe>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 student-image-col">
                ...
                <img src="upload/infra/student-1.webp" alt="GNC B.Sc. Food Technology Students" class="student-img-cutout">
            </div>
            ...
            <div class="col-lg-5 ps-lg-4 acp-text-padding acp-content-col" style="padding-left: 3.5rem !important;">
                <h3>Career Opportunities in <br>Food Technology (B.Sc. Food Technology)</h3>
                <p>Graduates of the B.Sc. Food Technology programs have diverse career opportunities in the food industry, which is one of the largest and most dynamic sectors globally. They can work in food manufacturing and processing industries, quality assurance, research and development of new food products, and food marketing and sales. </p>
                
                <p>Opportunities also exist in government regulatory bodies for roles in food safety and standards enforcement. Some graduates may choose careers in hospitality and food service management. Further, there is scope for entrepreneurial ventures, such as starting food processing units or developing innovative food products. Higher studies in food technology or related fields can lead to academic or research-oriented careers.</p>
            </div>

            <!-- 3. Key Career Fields (Right) -->
            <div class="col-lg-3 salient-features-col" style="padding-bottom: 2rem;">
                <h6 class="fw-bold mb-4" style="font-size: 1rem;">Food Technology Career Scope</h6>
                <ul class="feature-list">
                    <li><i class="fas fa-check"></i>
                        <div><b>Manufacturing & Processing:</b> Working in large-scale food production and processing industries.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Quality Assurance:</b> Ensuring food safety, quality control, and standards compliance.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>R&D:</b> Research and development of innovative food products and nutritional solutions.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Regulatory Bodies:</b> Roles in government agencies for food safety and standards enforcement.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Hospitality & Management:</b> Careers in high-end food service management and hospitality sectors.</div>
                    </li>
                    <li><i class="fas fa-check"></i>
                        <div><b>Entrepreneurship:</b> Scope for starting food processing units and independent ventures.</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="why-join-content">
                    <h3>Why Join Guru Nank College For Bachelor of Science in Food technology in Dehradun?</h3>
                    <p>The B.Sc. Food Technology program at Guru Nanak College stands out for several reasons:</p>

                    <ul class="check-list-white">
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">A comprehensive and updated curriculum that covers all key areas of food technology.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">State-of-the-art laboratory facilities for practical training in food processing and analysis.</p>
                            </div>
                        </li>
                        ...
                        <li class="d-flex align-items-start mb-3">
                            <i class="fas fa-check mt-1"></i>
                            <div class="ms-3">
                                <p class="mb-0">Hands-on learning opportunities through industrial visits, internships, and projects with food industries.</p>
                            </div>
                        </li>
