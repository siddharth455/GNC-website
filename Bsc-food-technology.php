                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Guru Nanak College - Best B.sc Food Technology College in Dehradun, Uttarakhand</h2>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="video-container">
                                <iframe src="https://www.youtube.com/embed/2YrZ-YwPMc0?autoplay=1&mute=1&playlist=2YrZ-YwPMc0&loop=1"
                        ...
                        <div class="col-lg-12 about-program-image">
                            <img src="upload/infra/life-allied.webp" alt="food technology showcasing" loading="lazy" style="width: -webkit-fill-available;">
                        </div>
                    </div>
...
<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Lateral Entry Fee Structure</button>
                        ...
                        <div id="printableArea">
                            <div class="course-heading">
                                <h2 style="text-align: center;">Bachelor of Science in Food Technology</h2>
                            </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>60,000 /- (Included Power Degree Fee)</b></td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
...
<ul class="llistStyle-2 p-0 mt-4 text-start course-list">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="llistStyle-2 p-0 mt-4 text-start course-list ps-2">
            <li>Admission to the B.Sc.Food Technology program at Guru Nanak College, Dehradun, is based on academic merit.</li>
            <li>Candidates are evaluated on their performance in the 10+2 examination, particularly in science subjects. The college may also conduct a counseling process to assess the candidates' aptitude and interest in the subjects.</li>
            </ul>
        </div>
    </section>
                ...
                <div class="col-lg-6 col-md-8 col-sm-10 mt-5">
                    <div class="bigInfo-section__content pb-5">
                        ...
                        <li>A comprehensive and updated curriculum that covers all key areas of food technology.</li>
                            ...
                            <li>The program is designed to equip students with a strong foundation in food science and technology, preparing them for a successful career in the ever-growing food industry. With career guidance and placement assistance, students are supported in achieving their professional goals, whether in the industry, entrepreneurship, or further studies in food technology.</li>
                                </ul>
                            </li>
                        </ul>
